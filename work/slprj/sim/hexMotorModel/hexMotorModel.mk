...
## Generated on : Thu Jul 23 13:04:58 2026
...
{$(START_DIR)\slprj\sim\hexMotorModel}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexMotorModel}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexMotorModel}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexMotorModel}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
hexMotorModel.obj : "$(START_DIR)\slprj\sim\hexMotorModel\hexMotorModel.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexMotorModel\hexMotorModel.c"


hexMotorModel_capi.obj : "$(START_DIR)\slprj\sim\hexMotorModel\hexMotorModel_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexMotorModel\hexMotorModel_capi.c"
