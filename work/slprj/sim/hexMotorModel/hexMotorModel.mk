...
## Generated on : Mon Jul 20 17:03:10 2026
## Final product: ./hexMotorModellib.lib
...
DEFINES_STANDARD = -DMODEL=hexMotorModel -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/hexMotorModel/hexMotorModel.c $(START_DIR)/slprj/sim/hexMotorModel/hexMotorModel_capi.c
...
OBJS = hexMotorModel.obj hexMotorModel_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/hexMotorModel/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexMotorModel/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexMotorModel/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexMotorModel/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexMotorModel/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
hexMotorModel.obj : $(START_DIR)/slprj/sim/hexMotorModel/hexMotorModel.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hexMotorModel_capi.obj : $(START_DIR)/slprj/sim/hexMotorModel/hexMotorModel_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
