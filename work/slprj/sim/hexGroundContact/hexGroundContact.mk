...
## Generated on : Thu Jul 23 13:06:09 2026
## Final product: .\hexGroundContactlib.lib
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = hexGroundContactlib.lib
...
PRODUCT = .\hexGroundContactlib.lib
...
SRCS = $(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact.c $(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact_capi.c
...
OBJS = hexGroundContact.obj hexGroundContact_capi.obj
...
{$(START_DIR)\slprj\sim\hexGroundContact}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexGroundContact}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexGroundContact}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexGroundContact}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
hexGroundContact.obj : "$(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact.c"


hexGroundContact_capi.obj : "$(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact_capi.c"
