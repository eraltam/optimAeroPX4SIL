...
## Generated on : Wed Jul 01 11:43:17 2026
...
%.obj : $(START_DIR)/slprj/sim/hexGroundContact/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexGroundContact/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexGroundContact/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexGroundContact/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexGroundContact/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
