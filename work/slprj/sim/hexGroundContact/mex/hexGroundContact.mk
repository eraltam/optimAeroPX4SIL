...
## Generated on : Thu Jul 23 13:06:11 2026
...
MODELREF_LINK_RSPFILE     = hexGroundContact_ref.rsp
COMPILER_COMMAND_FILE     = hexGroundContact_comp.rsp
CMD_FILE                  = hexGroundContact.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\hexGroundContact_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=hexGroundContact -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = hexGroundContact_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\hexGroundContact\hexGroundContactlib.lib
...
LDFLAGS_ = /IMPLIB:hexGroundContact_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:hexGroundContact_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:hexGroundContact_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:hexGroundContact_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
hexGroundContact_msf.obj : "$(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexGroundContact\hexGroundContact_msf.c"
