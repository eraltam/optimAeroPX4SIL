...
#define S_FUNCTION_NAME hexGroundContact_msf
#endif
...
#include "hexGroundContact_private.h"
...
rt_GetOSigstreamManager ( void ) { return NULL ; } void * rt_slioCatalogue ( void ) { return NULL ; } void * rtwGetPointerFromUniquePtr ( void * uniquePtr ) { return NULL ; } void * CreateDiagnosticAsVoidPtr ( const char * id , int nargs , ... ) { void * voidPtrDiagnostic = NULL ; va_list args ; va_start ( args , nargs ) ; slmrCreateDiagnostic ( id , nargs , args , & voidPtrDiagnostic ) ; va_end ( args ) ; return voidPtrDiagnostic ; } void rt_ssSet_slErrMsg ( void * S , void * diag ) { SimStruct * simStrcut = ( SimStruct * ) S ; if ( ! _ssIsErrorStatusAslErrMsg ( simStrcut ) ) { _ssSet_slLocalErrMsg ( simStrcut , diag ) ; } else { _ssDiscardDiagnostic ( simStrcut , diag ) ; } } void rt_ssReportDiagnosticAsWarning ( void * S , void * diag ) { _ssReportDiagnosticAsWarning ( ( SimStruct * ) S , diag ) ; } void rt_ssReportDiagnosticAsInfo ( void * S , void * diag ) { _ssReportDiagnosticAsInfo ( ( SimStruct * ) S , diag ) ; } const char * rt_CreateFullPathToTop ( const char * toppath , const char * subpath ) { char * fullpath = NULL ; slmrCreateFullPathToTop ( toppath , subpath , & fullpath ) ; return fullpath ; } boolean_T slIsRapidAcceleratorSimulating ( void ) { return false ; } void rt_RAccelReplaceFromFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void rt_RAccelReplaceToFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void * slsa_malloc ( size_t s ) { return malloc ( s ) ; } void slsa_free ( void * ptr ) { free ( ptr ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { dz2poepecm5 * dw = ( dz2poepecm5 * ) ssGetDWork ( S , 0 ) ; real_T const * i_cuafodlwx4 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_ge42tay1ww = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_i4yyvdtf1d = ( real_T * ) ssGetInputPortSignal ( S , 10 ) ; real_T const * i_jatkwde4be = ( real_T * ) ssGetInputPortSignal ( S , 11 ) ; real_T const * i_oshysbtvbf = ( real_T * ) ssGetInputPortSignal ( S , 12 ) ; real_T const * i_bfskih51v2 = ( real_T * ) ssGetInputPortSignal ( S , 13 ) ; real_T const * i_avyuh32ozr = ( real_T * ) ssGetInputPortSignal ( S , 14 ) ; real_T const * i_lm0ck0emmw = ( real_T * ) ssGetInputPortSignal ( S , 15 ) ; real_T const * i_la3qvj2jzo = ( real_T * ) ssGetInputPortSignal ( S , 18 ) ; real_T const * i_ebgwkxq1dc = ( real_T * ) ssGetInputPortSignal ( S , 21 ) ; real_T const * i_jsfiholn4s = ( real_T * ) ssGetInputPortSignal ( S , 23 ) ; boolean_T * o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_2_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_2_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; if ( tid == 0 ) { hexGroundContact ( & ( dw -> rtm ) , i_cuafodlwx4 , i_ge42tay1ww , i_i4yyvdtf1d , i_jatkwde4be , i_oshysbtvbf , i_bfskih51v2 , i_avyuh32ozr , i_lm0ck0emmw , i_la3qvj2jzo , i_ebgwkxq1dc , i_jsfiholn4s , o_B_2_1 , o_B_2_2 , o_B_2_3 , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 24 , 3 ) ; if ( ! ssSetNumInputPorts ( S , 24 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 3 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
...
ssSetInputPortVectorDimension ( S , 7 , 3 ) ) return ;
...
ssSetInputPortMatrixDimensions ( S , 21 , 3 , 3 ) ) return ;
...
ssSetInputPortOffsetTime ( S , 23 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S ,
3 ) ) return ; if ( ! ssSetOutputPortVectorDimension ( S , 0 , 1 ) ) return ;
...
mr_hexGroundContact_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_hexGroundContact_MdlInfoRegFcn ( S , "hexGroundContact" , & retVal ) ; if
( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( dz2poepecm5 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { dz2poepecm5 * dw = ( dz2poepecm5 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid == CONSTANT_TID ) { contextTid = 0 ; } simTgtAllocOPModelData ( S ) ; bjz0njqoy1 ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtdw ) , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } oejdm1huzg ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { dz2poepecm5 * dw = ( dz2poepecm5 * ) ssGetDWork ( S , 0 )
; real_T const * i_cuafodlwx4 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_ge42tay1ww = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T const * i_i4yyvdtf1d = ( real_T * ) ssGetInputPortSignal ( S , 10 ) ;
real_T const * i_jatkwde4be = ( real_T * ) ssGetInputPortSignal ( S , 11 ) ;
real_T const * i_oshysbtvbf = ( real_T * ) ssGetInputPortSignal ( S , 12 ) ;
real_T const * i_bfskih51v2 = ( real_T * ) ssGetInputPortSignal ( S , 13 ) ;
real_T const * i_avyuh32ozr = ( real_T * ) ssGetInputPortSignal ( S , 14 ) ;
real_T const * i_lm0ck0emmw = ( real_T * ) ssGetInputPortSignal ( S , 15 ) ;
real_T const * i_la3qvj2jzo = ( real_T * ) ssGetInputPortSignal ( S , 18 ) ;
real_T const * i_ebgwkxq1dc = ( real_T * ) ssGetInputPortSignal ( S , 21 ) ;
real_T const * i_jsfiholn4s = ( real_T * ) ssGetInputPortSignal ( S , 23 ) ;
boolean_T * o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real_T * o_B_2_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T *
o_B_2_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { hexGroundContact ( & ( dw -> rtm ) , i_cuafodlwx4 ,
i_ge42tay1ww , i_i4yyvdtf1d , i_jatkwde4be , i_oshysbtvbf , i_bfskih51v2 ,
i_avyuh32ozr , i_lm0ck0emmw , i_la3qvj2jzo , i_ebgwkxq1dc , i_jsfiholn4s ,
o_B_2_1 , o_B_2_2 , o_B_2_3 , & ( dw -> rtdw ) ) ; } } static void
mdlTerminate ( SimStruct * S ) { dz2poepecm5 * dw = ( dz2poepecm5 * )
ssGetDWork ( S , 0 ) ; irs14nz5it ( & ( dw -> rtm ) ) ; simTgtFreeOPModelData
( S ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { dz2poepecm5 * dw =
( dz2poepecm5 * ) ssGetDWork ( S , 0 ) ; mpzatt4icf ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; }
...
mxArray * mdlrefDW = mr_hexGroundContact_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_hexGroundContact_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_hexGroundContact_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
