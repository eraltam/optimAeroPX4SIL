...
boolean_T * o_B_3_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T *
o_B_3_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; if ( tid ==
...
o_B_3_1 , o_B_3_2 , o_B_3_3 , & ( dw -> rtdw ) ) ; } } static void
