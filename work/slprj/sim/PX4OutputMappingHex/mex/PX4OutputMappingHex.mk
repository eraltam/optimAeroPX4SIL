...
## Generated on : Thu Jul 23 13:03:51 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\PX4OutputMappingHex_msf.mexw64
...
PRODUCT_NAME              = PX4OutputMappingHex
MAKEFILE                  = PX4OutputMappingHex.mk
...
MODELREF_LINK_RSPFILE     = PX4OutputMappingHex_ref.rsp
COMPILER_COMMAND_FILE     = PX4OutputMappingHex_comp.rsp
CMD_FILE                  = PX4OutputMappingHex.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\PX4OutputMappingHex_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=PX4OutputMappingHex -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = PX4OutputMappingHex_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHexlib.lib
...
LDFLAGS_ = /IMPLIB:PX4OutputMappingHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:PX4OutputMappingHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:PX4OutputMappingHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:PX4OutputMappingHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
PX4OutputMappingHex_msf.obj : "$(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex_msf.c"
