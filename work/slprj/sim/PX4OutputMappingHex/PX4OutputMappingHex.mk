...
## Generated on : Thu Jul 23 13:03:48 2026
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = PX4OutputMappingHexlib.lib
...
PRODUCT = .\PX4OutputMappingHexlib.lib
...
SRCS = $(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex.c $(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex_capi.c
...
OBJS = PX4OutputMappingHex.obj PX4OutputMappingHex_capi.obj
...
{$(START_DIR)\slprj\sim\PX4OutputMappingHex}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\PX4OutputMappingHex}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\PX4OutputMappingHex}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\PX4OutputMappingHex}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
PX4OutputMappingHex.obj : "$(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex.c"


PX4OutputMappingHex_capi.obj : "$(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\PX4OutputMappingHex\PX4OutputMappingHex_capi.c"
