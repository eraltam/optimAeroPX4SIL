...
o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_1_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_1_6 = ( real_T * ) ssGetOutputPortSignal ( S , 5 ) ; if ( tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { PX4OutputMappingHex ( & ( dw -> rtm ) , i_jybsax55pr , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , & ( dw -> rtdw ) ) ; } } static void mdlTerminate ( SimStruct * S ) { ol2n430xj13 * dw = ( ol2n430xj13 * ) ssGetDWork ( S , 0 ) ; kyuedg42rr ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_PX4OutputMappingHex_GetDWork ( ssGetDWork ( S , 0 ) ) ;
