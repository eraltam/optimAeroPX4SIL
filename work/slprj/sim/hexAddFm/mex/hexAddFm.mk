...
## Generated on : Thu Jul 23 13:05:25 2026
...
MODELREF_LINK_RSPFILE     = hexAddFm_ref.rsp
COMPILER_COMMAND_FILE     = hexAddFm_comp.rsp
CMD_FILE                  = hexAddFm.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\hexAddFm_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=hexAddFm -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\hexAddFm\hexAddFm_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = hexAddFm_msf.obj c_mexapi_version.obj
...
LDFLAGS_ = /IMPLIB:hexAddFm_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:hexAddFm_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:hexAddFm_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:hexAddFm_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
hexAddFm_msf.obj : "$(START_DIR)\slprj\sim\hexAddFm\hexAddFm_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAddFm\hexAddFm_msf.c"
