...
#define S_FUNCTION_NAME hexAddFm_msf
#endif
...
rt_GetOSigstreamManager ( void ) { return NULL ; } void * rt_slioCatalogue ( void ) { return NULL ; } void * rtwGetPointerFromUniquePtr ( void * uniquePtr ) { return NULL ; } void * CreateDiagnosticAsVoidPtr ( const char * id , int nargs , ... ) { void * voidPtrDiagnostic = NULL ; va_list args ; va_start ( args , nargs ) ; slmrCreateDiagnostic ( id , nargs , args , & voidPtrDiagnostic ) ; va_end ( args ) ; return voidPtrDiagnostic ; } void rt_ssSet_slErrMsg ( void * S , void * diag ) { SimStruct * simStrcut = ( SimStruct * ) S ; if ( ! _ssIsErrorStatusAslErrMsg ( simStrcut ) ) { _ssSet_slLocalErrMsg ( simStrcut , diag ) ; } else { _ssDiscardDiagnostic ( simStrcut , diag ) ; } } void rt_ssReportDiagnosticAsWarning ( void * S , void * diag ) { _ssReportDiagnosticAsWarning ( ( SimStruct * ) S , diag ) ; } void rt_ssReportDiagnosticAsInfo ( void * S , void * diag ) { _ssReportDiagnosticAsInfo ( ( SimStruct * ) S , diag ) ; } const char * rt_CreateFullPathToTop ( const char * toppath , const char * subpath ) { char * fullpath = NULL ; slmrCreateFullPathToTop ( toppath , subpath , & fullpath ) ; return fullpath ; } boolean_T slIsRapidAcceleratorSimulating ( void ) { return false ; } void rt_RAccelReplaceFromFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void rt_RAccelReplaceToFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void * slsa_malloc ( size_t s ) { return malloc ( s ) ; } void slsa_free ( void * ptr ) { free ( ptr ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { eckipmdqplk * dw = ( eckipmdqplk * ) ssGetDWork ( S , 0 ) ; real_T const * i_bxf31drh2l = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_mosmp0wvva = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_fu01y22uaf = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_e50rc3xswd = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_apafvgd1rw = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_mngpwiimoj = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_dypf2tqtd4 = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T const * i_bdqzrbpe0w = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ; real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_1_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_1_6 = ( real_T * ) ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_1_7 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; real_T * o_B_1_8 = ( real_T * ) ssGetOutputPortSignal ( S , 7 ) ; real_T * o_B_1_9 = ( real_T * ) ssGetOutputPortSignal ( S , 8 ) ; real_T * o_B_1_10 = ( real_T * ) ssGetOutputPortSignal ( S , 9 ) ; if ( tid == 0 ) { hexAddFm ( & ( dw -> rtm ) , i_bxf31drh2l , i_mosmp0wvva , i_fu01y22uaf , i_e50rc3xswd , i_apafvgd1rw , i_mngpwiimoj , i_dypf2tqtd4 , i_bdqzrbpe0w , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , o_B_1_7 , o_B_1_8 , o_B_1_9 , o_B_1_10 , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 8 , 10 ) ; if ( ! ssSetNumInputPorts ( S , 8 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 3 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
...
( S , 7 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 10 ) ) return ; if ( !
...
ssSetOutputPortOptimOpts ( S , 9 , SS_NOT_REUSABLE_AND_LOCAL ) ;
ssSetSimStateCompliance ( S , USE_CUSTOM_SIM_STATE ) ;
mr_hexAddFm_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_hexAddFm_MdlInfoRegFcn ( S
, "hexAddFm" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( eckipmdqplk ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { eckipmdqplk * dw = ( eckipmdqplk * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid == CONSTANT_TID ) { contextTid = 0 ; } simTgtAllocOPModelData ( S ) ; gqyvwzowyf ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , & ( dw -> rtm ) , & ( dw -> rtdw ) , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } e5pwjmiupg ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { eckipmdqplk * dw = ( eckipmdqplk * ) ssGetDWork ( S , 0 )
; real_T const * i_bxf31drh2l = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_mosmp0wvva = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T const * i_fu01y22uaf = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
real_T const * i_e50rc3xswd = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
real_T const * i_apafvgd1rw = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ;
real_T const * i_mngpwiimoj = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ;
real_T const * i_dypf2tqtd4 = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ;
real_T const * i_bdqzrbpe0w = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_1_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_1_6 = ( real_T * ) ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_1_7 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; real_T * o_B_1_8 = ( real_T * ) ssGetOutputPortSignal ( S , 7 ) ; real_T * o_B_1_9 = ( real_T * ) ssGetOutputPortSignal ( S , 8 ) ; real_T * o_B_1_10 = ( real_T * ) ssGetOutputPortSignal ( S , 9 ) ; if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { hexAddFm ( & ( dw -> rtm ) , i_bxf31drh2l , i_mosmp0wvva , i_fu01y22uaf , i_e50rc3xswd , i_apafvgd1rw , i_mngpwiimoj , i_dypf2tqtd4 , i_bdqzrbpe0w , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , o_B_1_7 , o_B_1_8 , o_B_1_9 , o_B_1_10 , & ( dw -> rtdw ) ) ; } } static void mdlTerminate ( SimStruct * S ) { eckipmdqplk * dw = ( eckipmdqplk * ) ssGetDWork ( S , 0 ) ; b2123yef1i ( & ( dw -> rtm ) ) ; simTgtFreeOPModelData ( S ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { eckipmdqplk * dw =
( eckipmdqplk * ) ssGetDWork ( S , 0 ) ; km11d4onwl ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; }
...
mxArray * mdlrefDW = mr_hexAddFm_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_hexAddFm_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 , 2
...
simTgtDeserializeVoidMemoryOP ( S , voidMemData ) ; } mr_hexAddFm_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1 ) ) ; ssSetTNext ( S , ( time_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 3 ) ) ) ; ssSetTNextTid ( S , ( int_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 4 ) ) ) ; }
