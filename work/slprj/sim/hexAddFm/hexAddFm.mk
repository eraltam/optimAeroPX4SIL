...
## Generated on : Thu Jul 23 13:05:23 2026
...
SRCS = $(START_DIR)\slprj\sim\hexAddFm\hexAddFm.c $(START_DIR)\slprj\sim\hexAddFm\hexAddFm_capi.c
...
OBJS = hexAddFm.obj hexAddFm_capi.obj
...
{$(START_DIR)\slprj\sim\hexAddFm}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAddFm}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAddFm}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAddFm}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
hexAddFm.obj : "$(START_DIR)\slprj\sim\hexAddFm\hexAddFm.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAddFm\hexAddFm.c"


hexAddFm_capi.obj : "$(START_DIR)\slprj\sim\hexAddFm\hexAddFm_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAddFm\hexAddFm_capi.c"
