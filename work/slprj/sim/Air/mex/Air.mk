###########################################################################
## Makefile generated for component 'Air'. 
## 
## Makefile     : Air.mk
## Generated on : Wed Jul 29 14:11:53 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Air_msf.mexw64
...
MODELREF_LINK_RSPFILE     = Air_ref.rsp
COMPILER_COMMAND_FILE     = Air_comp.rsp
CMD_FILE                  = Air.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Air_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=Air -DNUMST=3 -DNCSTATES=22 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\Air\Air_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = Air_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\Air\Airlib.lib
...
LDFLAGS_ = /IMPLIB:Air_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:Air_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:Air_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:Air_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
Air_msf.obj : "$(START_DIR)\slprj\sim\Air\Air_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\Air\Air_msf.c"
