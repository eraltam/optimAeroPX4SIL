...
rtcapiStoredFloats [ 0 ] , ( const void * ) & rtcapiStoredFloats [ 0 ] , ( int8_T ) 0 , ( uint8_T ) 0 } } ; static int_T rtContextSystems [ 22 ] ; static rtwCAPI_LoggingMetaInfo loggingMetaInfo [ ] = { { 0 , 0 , "" , 0 } } ; static rtwCAPI_ModelMapLoggingStaticInfo mmiStaticInfoLogging = { 22 , rtContextSystems , loggingMetaInfo , 0 , ( NULL ) , { 0 , ( NULL ) , ( NULL ) } , 0 , ( NULL ) } ; static rtwCAPI_ModelMappingStaticInfo mmiStatic = { { rtBlockSignals , 0 , ( NULL ) , 0 , ( NULL ) , 0 } , { ( NULL ) , 0 , ( NULL ) , 0 } , { rtBlockStates , 14 } , { rtDataTypeMap , rtDimensionMap , rtFixPtMap , rtElementMap , rtSampleTimeMap , rtDimensionArray } , "float" , { 3519375108U , 2678550303U , 490464443U , 3235281640U } , & mmiStaticInfoLogging , 0 , ( boolean_T ) 0 , rt_LoggedStateIdxList } ; const rtwCAPI_ModelMappingStaticInfo * Air_GetCAPIStaticMap ( void ) { return & mmiStatic ; }
#ifndef HOST_CAPI_BUILD
...
rootSysRanPtr ; systemRan [ 1 ] = ( sysRanDType * ) & localDW -> hcrr45luqwm
. oksyj0jv2v ; systemRan [ 2 ] = ( sysRanDType * ) & localDW -> irpvfptwfro .
jh2h5ufsn0 ; systemRan [ 3 ] = ( sysRanDType * ) & localDW -> cp345krnyk .
jh2h5ufsn0 ; systemRan [ 4 ] = ( sysRanDType * ) & localDW -> fj0c5tjfqn .
oksyj0jv2v ; systemRan [ 5 ] = ( sysRanDType * ) & localDW -> kf3n24jn2o .
jh2h5ufsn0 ; systemRan [ 6 ] = ( sysRanDType * ) & localDW -> gxezufcodw .
jh2h5ufsn0 ; systemRan [ 7 ] = ( sysRanDType * ) & localDW -> fodof2x2t4 ;
systemRan [ 8 ] = ( sysRanDType * ) & localDW -> gedgrbiut4 ; systemRan [ 9 ]
= ( sysRanDType * ) & localDW -> k1kdhj0lsd ; systemRan [ 10 ] = ( sysRanDType
* ) & localDW -> ic0ali3zew ; systemRan [ 11 ] = ( sysRanDType * ) & localDW
-> dkukdnfsuk ; systemRan [ 12 ] = ( sysRanDType * ) & localDW -> pntrgqb3jy
; systemRan [ 13 ] = ( sysRanDType * ) & localDW -> ls4kddknva ; systemRan [
14 ] = ( sysRanDType * ) & localDW -> dj24cjnutv ; systemRan [ 15 ] = ( sysRanDType * ) & localDW -> gg0vkz2ya5 ; systemRan [ 16 ] = ( sysRanDType * ) & localDW -> jcuathgxxh ; systemRan [ 17 ] = ( sysRanDType * ) & localDW -> bpivcbzlyi ; systemRan [ 18 ] = ( sysRanDType * ) & localDW -> isiljl3bu1 ; systemRan [ 19 ] = ( sysRanDType * ) & localDW -> obi4asdoze ; systemRan [ 20 ] = ( sysRanDType * ) & localDW -> irozwsyzkd ; systemRan [ 21 ] = ( NULL ) ; systemTid [ 1 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 4 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 2 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 3 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 5 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 6 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 7 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 8 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 9 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 10 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 11 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 12 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 13 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 15 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 16 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 14 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 18 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 19 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 17 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 20 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 21 ] = nvfdhrszo5 -> Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 0 ] = rootTid ; rtContextSystems [ 0 ] = 0 ; rtContextSystems [ 1 ] = 1 ; rtContextSystems [ 2 ] = 2 ; rtContextSystems [ 3 ] = 3 ; rtContextSystems [ 4 ] = 4 ; rtContextSystems [ 5 ] = 5 ; rtContextSystems [ 6 ] = 6 ; rtContextSystems [ 7 ] = 7 ; rtContextSystems [ 8 ] = 8 ; rtContextSystems [ 9 ] = 9 ; rtContextSystems [ 10 ] = 10 ; rtContextSystems [ 11 ] = 11 ; rtContextSystems [ 12 ] = 12 ; rtContextSystems [ 13 ] = 13 ; rtContextSystems [ 14 ] = 14 ; rtContextSystems [ 15 ] = 15 ; rtContextSystems [ 16 ] = 16 ; rtContextSystems [ 17 ] = 17 ; rtContextSystems [ 18 ] = 18 ; rtContextSystems [ 19 ] = 19 ; rtContextSystems [ 20 ] = 20 ; rtContextSystems [ 21 ] = 0 ; }
#endif
#ifndef HOST_CAPI_BUILD
