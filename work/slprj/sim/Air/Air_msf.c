...
static void mdlProcessParameters ( SimStruct * S ) { real_T * GlobalPrm_0 = ( real_T * ) NULL ; real_T * GlobalPrm_1 = ( real_T * ) NULL ; real_T * GlobalPrm_2 = ( real_T * ) NULL ; real_T * GlobalPrm_3 = ( real_T * ) NULL ; real_T * GlobalPrm_4 = ( real_T * ) NULL ; real_T * GlobalPrm_5 = ( real_T * ) NULL ; real_T * GlobalPrm_6 = ( real_T * ) NULL ; real_T * GlobalPrm_7 = ( real_T * ) NULL ; real_T * GlobalPrm_8 = ( real_T * ) NULL ; real_T * GlobalPrm_9 = ( real_T * ) NULL ; real_T * GlobalPrm_10 = ( real_T * ) NULL ; boolean_T * GlobalPrm_11 = ( boolean_T * ) NULL ; boolean_T * GlobalPrm_12 = ( boolean_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_gustAmplitude_mps [ 0 ] ) , GlobalPrm_0 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP_gustDuration_sec ) , GlobalPrm_1 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & ( rtP_gustLength_m [ 0 ] ) , GlobalPrm_2 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 3 , ( void * * ) ( & GlobalPrm_3 ) ) ) return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy ( & ( rtP_gustStartTime_sec ) , GlobalPrm_3 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 4 , ( void * * ) ( & GlobalPrm_4 ) ) ) return ; if ( GlobalPrm_4 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceEndTime_sec ) , GlobalPrm_4 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 5 , ( void * * ) ( & GlobalPrm_5 ) ) ) return ; if ( GlobalPrm_5 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceMinAirspeed_mps ) , GlobalPrm_5 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 6 , ( void * * ) ( & GlobalPrm_6 ) ) ) return ; if ( GlobalPrm_6 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceStartTime_sec ) , GlobalPrm_6 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 7 , ( void * * ) ( & GlobalPrm_7 ) ) ) return ; if ( GlobalPrm_7 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceWingspan_m ) , GlobalPrm_7 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 8 , ( void * * ) ( & GlobalPrm_8 ) ) ) return ; if ( GlobalPrm_8 != NULL ) { ( void ) memcpy ( & ( rtP_xWindInNED_mps ) , GlobalPrm_8 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 9 , ( void * * ) ( & GlobalPrm_9 ) ) ) return ; if ( GlobalPrm_9 != NULL ) { ( void ) memcpy ( & ( rtP_yWindInNED_mps ) , GlobalPrm_9 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 10 , ( void * * ) ( & GlobalPrm_10 ) ) ) return ; if ( GlobalPrm_10 != NULL ) { ( void ) memcpy ( & ( rtP_zWindInNED_mps ) , GlobalPrm_10 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 11 , ( void * * ) ( & GlobalPrm_11 ) ) ) return ; if ( GlobalPrm_11 != NULL ) { ( void ) memcpy ( & ( rtP_gustEnabled ) , GlobalPrm_11 , sizeof ( boolean_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 12 , ( void * * ) ( & GlobalPrm_12 ) ) ) return ; if ( GlobalPrm_12 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceEnabled ) , GlobalPrm_12 , sizeof ( boolean_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { pp2a15jtu4d * dw = ( pp2a15jtu4d * ) ssGetDWork ( S , 0 ) ; real_T * o_o_B_17_6 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; real_T * o_o_B_17_7 = ( real_T * ) ssGetOutputPortSignal ( S , 7 ) ; pjetdmxrlz * localX = ( pjetdmxrlz * ) ssGetContStates ( S ) ; eml2bfmjzs ( o_o_B_17_6 , o_o_B_17_7 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { pp2a15jtu4d * dw = ( pp2a15jtu4d * ) ssGetDWork ( S , 0 ) ; real_T const * i_bhv1zga33q = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_jf5c3mld2i = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_cyyqri2cma = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ; real_T * o_B_17_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_17_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_17_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_17_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_17_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_o_B_17_6 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; real_T * o_o_B_17_7 = ( real_T * ) ssGetOutputPortSignal ( S , 7 ) ; pjetdmxrlz * localX = ( pjetdmxrlz * ) ssGetContStates ( S ) ; f5nf4hs4w3 * localXdis = ( f5nf4hs4w3 * ) ssGetContStateDisabled ( S ) ; if ( tid == 0 ) { Air ( & ( dw -> rtm ) , i_bhv1zga33q , i_jf5c3mld2i , i_cyyqri2cma , o_B_17_1 , o_B_17_2 , o_B_17_3 , o_B_17_4 , o_B_17_5 , o_o_B_17_6 , o_o_B_17_7 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , localXdis ) ; hqhjziniu5 ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 22 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetNumPeriodicContStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 9 , 8 ) ; if ( ! ssSetNumInputPorts ( S , 9 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 3 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
o_B_17_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_17_2 =
( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_17_3 = ( real_T *
) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_17_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_17_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_o_B_17_6 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; real_T * o_o_B_17_7 = ( real_T * )
ssGetOutputPortSignal ( S , 7 ) ; pjetdmxrlz * localX = ( pjetdmxrlz * )
ssGetContStates ( S ) ; f5nf4hs4w3 * localXdis = ( f5nf4hs4w3 * )
ssGetContStateDisabled ( S ) ; real_T * o_B_17_8 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; if ( tid == PARAMETER_TUNING_TID ) {
AirTID3 ( & ( dw -> rtm ) , o_B_17_8 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ;
} if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit
( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) { Air ( & ( dw -> rtm ) ,
i_bhv1zga33q , i_jf5c3mld2i , i_cyyqri2cma , o_B_17_1 , o_B_17_2 , o_B_17_3 ,
o_B_17_4 , o_B_17_5 , o_o_B_17_6 , o_o_B_17_7 , & ( dw -> rtb ) , & ( dw ->
