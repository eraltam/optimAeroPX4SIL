...
rtSampleTimeMap , rtDimensionArray } , "float" , { 4210401128U , 106970966U ,
344084662U , 2619413417U } , & mmiStaticInfoLogging , 0 , ( boolean_T ) 0 ,
...
void * rootSysRanPtr , int rootTid ) { UNUSED_PARAMETER ( hsrfiqrkgc ) ;
UNUSED_PARAMETER ( localDW ) ; systemRan [ 0 ] = ( sysRanDType * )
rootSysRanPtr ; systemRan [ 1 ] = ( NULL ) ; systemTid [ 1 ] = hsrfiqrkgc ->
Timing . mdlref_GlobalTID [ 0 ] ; systemTid [ 0 ] = rootTid ;
rtContextSystems [ 0 ] = 0 ; rtContextSystems [ 1 ] = 0 ; }
#endif
#ifndef HOST_CAPI_BUILD
void adc_InitializeDataMapInfo ( ejys33derb * const hsrfiqrkgc , fu5g1quldg *
localDW , void * sysRanPtr , int_T contextTid ) { rtwCAPI_SetVersion ( hsrfiqrkgc -> DataMapInfo . mmi , 1 ) ; rtwCAPI_SetStaticMap ( hsrfiqrkgc -> DataMapInfo . mmi , & mmiStatic ) ; rtwCAPI_SetLoggingStaticMap ( hsrfiqrkgc -> DataMapInfo . mmi , & mmiStaticInfoLogging ) ; rtwCAPI_SetPath ( hsrfiqrkgc -> DataMapInfo . mmi , ( NULL ) ) ; rtwCAPI_SetFullPath ( hsrfiqrkgc -> DataMapInfo . mmi , ( NULL ) ) ; rtwCAPI_SetInstanceLoggingInfo ( hsrfiqrkgc -> DataMapInfo . mmi , & hsrfiqrkgc -> DataMapInfo . mmiLogInstanceInfo ) ; rtwCAPI_SetChildMMIArray ( hsrfiqrkgc -> DataMapInfo . mmi , ( NULL ) ) ; rtwCAPI_SetChildMMIArrayLen ( hsrfiqrkgc -> DataMapInfo . mmi , 0 ) ; adc_InitializeSystemRan ( hsrfiqrkgc , hsrfiqrkgc -> DataMapInfo . systemRan , localDW , hsrfiqrkgc -> DataMapInfo . systemTid , sysRanPtr , contextTid ) ; rtwCAPI_SetSystemRan ( hsrfiqrkgc -> DataMapInfo . mmi , hsrfiqrkgc -> DataMapInfo . systemRan ) ; rtwCAPI_SetSystemTid ( hsrfiqrkgc -> DataMapInfo . mmi , hsrfiqrkgc -> DataMapInfo . systemTid ) ; rtwCAPI_SetGlobalTIDMap ( hsrfiqrkgc -> DataMapInfo . mmi , & hsrfiqrkgc -> Timing . mdlref_GlobalTID [ 0 ] ) ; }
#else
#ifdef __cplusplus
extern "C" {
#endif
