...
#endif
extern bhhzm0uwhmt bhhzm0uwhm ; void InitCalcAtmosCOESA ( real_T *
temperature76 , real_T * pressureRatio76 ) ; void CalcPAltCOESA ( const
real_T * pressure , real_T * altitude , real_T * temperature76 , real_T *
pressureRatio76 , int_T numPoints ) ;
#endif
