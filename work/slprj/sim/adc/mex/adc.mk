...
## 
## Makefile     : adc.mk
## Generated on : Wed Jul 29 14:14:43 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\adc_msf.mexw64
...
MODELREF_LINK_RSPFILE     = adc_ref.rsp
COMPILER_COMMAND_FILE     = adc_comp.rsp
CMD_FILE                  = adc.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\adc_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=adc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\adc\adc_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = adc_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\adc\adclib.lib
...
LDFLAGS_ = /IMPLIB:adc_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:adc_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:adc_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:adc_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
adc_msf.obj : "$(START_DIR)\slprj\sim\adc\adc_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\adc\adc_msf.c"
