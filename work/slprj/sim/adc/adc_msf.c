...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:LoggingBlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">YQBkAGMALwBCAGEAcgBvAFMAZQBuAHMAbwByAEIAdQBzAAAA</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAsAJmrEA=</h></hs><causes><diag id=\"Simulink:logLoadBlocks:SigLogMultiExecInsNoBusSupportMsg\" pr=\"d\"><msg encoded=\"yes\">TwBuAGwAeQAgAG4AbwBuAC0AYgB1AHMAIABzAGkAZwBuAGEAbABzACAAYwBhAG4AIABiAGUAIABsAG8AZwBnAGUAZAAgAGkAbgBzAGkAZABlACAARgBvAHIAIABFAGEAYwBoACAAcwB1AGIAcwB5AHMAdABlAG0AcwAuAAAA</msg></diag></causes></diag></diag_root>"
...
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; ltbspptju1 ( & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; gokq5jjs53 ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_adc_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss
...
mr_adc_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1 ) )
