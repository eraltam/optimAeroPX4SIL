...
#define S_FUNCTION_NAME adc_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_1_6 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; d5o2ouci45 ( o_o_o_o_B_1_6 , & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_1_6 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; jzvflsluq2 ( o_o_o_o_B_1_6 , & ( dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; real_T const * i_g2qiaxik2k = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_at5umcohjl = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_alpnb4fvm3 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_gindllzpt2 = ( real_T * ) ssGetInputPortSignal ( S , 12 ) ; real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_1_5 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; if ( tid == 0 ) { adc ( & ( dw -> rtm ) , i_g2qiaxik2k , i_at5umcohjl , i_alpnb4fvm3 , i_gindllzpt2 , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; ltbspptju1 ( & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 15 , 7 ) ; if ( ! ssSetNumInputPorts ( S , 15 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
mr_adc_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:LoggingBlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">YQBkAGMALwBCAGEAcgBvAFMAZQBuAHMAbwByAEIAdQBzAAAA</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAgAFirkA=</h></hs><causes><diag id=\"Simulink:logLoadBlocks:SigLogMultiExecInsNoBusSupportMsg\" pr=\"d\"><msg encoded=\"yes\">TwBuAGwAeQAgAG4AbwBuAC0AYgB1AHMAIABzAGkAZwBuAGEAbABzACAAYwBhAG4AIABiAGUAIABsAG8AZwBnAGUAZAAgAGkAbgBzAGkAZABlACAARgBvAHIAIABFAGEAYwBoACAAcwB1AGIAcwB5AHMAdABlAG0AcwAuAAAA</msg></diag></causes></diag></diag_root>"
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_adc_MdlInfoRegFcn ( S ,
"adc" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( ajsi3uhw15h ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_1_6 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid == CONSTANT_TID ) { contextTid = 0 ; } simTgtAllocOPModelData ( S ) ; lcjgg50y0j ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } datkbpvk0h ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * )
ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_1_6 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; mdlProcessParameters ( S ) ; dsarn04rkd ( o_o_o_o_B_1_6 , & ( dw -> rtdw ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; real_T const * i_g2qiaxik2k = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_at5umcohjl = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_alpnb4fvm3 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_gindllzpt2 = ( real_T * ) ssGetInputPortSignal ( S , 12 ) ; real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_1_5 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; real_T * o_o_o_o_B_1_6 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_7 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; if ( tid == PARAMETER_TUNING_TID ) { adcTID1 ( & ( dw -> rtm ) , o_o_o_o_B_1_6 , o_B_1_7 , & ( dw -> rtdw ) ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { adc ( & ( dw -> rtm ) , i_g2qiaxik2k , i_at5umcohjl , i_alpnb4fvm3 , i_gindllzpt2 , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; ltbspptju1 ( & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { ajsi3uhw15h * dw = ( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; gokq5jjs53 ( & ( dw -> rtm ) ) ; simTgtFreeOPModelData ( S ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { ajsi3uhw15h * dw =
( ajsi3uhw15h * ) ssGetDWork ( S , 0 ) ; ck42tyjtk5 ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; }
...
mxArray * mdlrefDW = mr_adc_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_adc_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 , 2 ,
...
simTgtDeserializeVoidMemoryOP ( S , voidMemData ) ; } mr_adc_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1 ) ) ; ssSetTNext ( S , ( time_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 3 ) ) ) ; ssSetTNextTid ( S , ( int_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 4 ) ) ) ; }
