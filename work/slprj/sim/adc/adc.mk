...
## 
## Makefile     : adc.mk
## Generated on : Wed Jul 29 14:14:40 2026
## Final product: .\adclib.lib
...
SRCS = $(START_DIR)\slprj\sim\adc\adc.c $(START_DIR)\slprj\sim\adc\adc_capi.c
...
{$(START_DIR)\slprj\sim\adc}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\adc}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\adc}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\adc}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
adc.obj : "$(START_DIR)\slprj\sim\adc\adc.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\adc\adc.c"


adc_capi.obj : "$(START_DIR)\slprj\sim\adc\adc_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\adc\adc_capi.c"
