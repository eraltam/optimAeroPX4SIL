...
## Generated on : Wed Jul 29 14:19:44 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\environment_msf.mexw64
...
MODELREF_LINK_RSPFILE     = environment_ref.rsp
COMPILER_COMMAND_FILE     = environment_comp.rsp
CMD_FILE                  = environment.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\environment_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=environment -DNUMST=3 -DNCSTATES=22 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\environment\environment_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = environment_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\ENVIRO~1\ENVIRO~1.LIB C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\Air\Airlib.lib C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\Earth\Earthlib.lib C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\LOCALT~1\LOCALT~1.LIB
...
LDFLAGS_ = /IMPLIB:environment_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:environment_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:environment_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:environment_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
environment_msf.obj : "$(START_DIR)\slprj\sim\environment\environment_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\environment\environment_msf.c"
