...
## Generated on : Wed Jul 29 04:05:54 2026
...
MODELREF_LIBS = C:/Users/Usuario/AnelloSummer/optimAeroPX4SIL/work/slprj/sim/Air/Airlib.lib C:/Users/Usuario/AnelloSummer/optimAeroPX4SIL/work/slprj/sim/Earth/Earthlib.lib C:/Users/Usuario/AnelloSummer/optimAeroPX4SIL/work/slprj/sim/LocalTerrain/LocalTerrainlib.lib
...
%.obj : $(START_DIR)/slprj/sim/environment/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/environment/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/environment/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/environment/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/environment/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
