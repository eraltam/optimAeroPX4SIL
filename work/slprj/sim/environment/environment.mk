...
## Generated on : Wed Jul 29 14:19:41 2026
...
SRCS = $(START_DIR)\slprj\sim\environment\environment.c $(START_DIR)\slprj\sim\environment\environment_capi.c
...
OBJS = environment.obj environment_capi.obj
...
MODELREF_LIBS = C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\Air\Airlib.lib C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\Earth\Earthlib.lib C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\LOCALT~1\LOCALT~1.LIB
...
{$(START_DIR)\slprj\sim\environment}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\environment}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\environment}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\environment}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
environment.obj : "$(START_DIR)\slprj\sim\environment\environment.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\environment\environment.c"


environment_capi.obj : "$(START_DIR)\slprj\sim\environment\environment_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\environment\environment_capi.c"
