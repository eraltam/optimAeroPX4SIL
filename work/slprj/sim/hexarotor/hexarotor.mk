...
## Generated on : Thu Jul 23 13:08:49 2026
...
SRCS = $(START_DIR)\slprj\sim\hexarotor\hexarotor.c $(START_DIR)\slprj\sim\hexarotor\hexarotor_capi.c
...
OBJS = hexarotor.obj hexarotor_capi.obj
...
{$(START_DIR)\slprj\sim\hexarotor}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexarotor}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexarotor}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexarotor}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
hexarotor.obj : "$(START_DIR)\slprj\sim\hexarotor\hexarotor.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexarotor\hexarotor.c"


hexarotor_capi.obj : "$(START_DIR)\slprj\sim\hexarotor\hexarotor_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexarotor\hexarotor_capi.c"
