...
## Generated on : Thu Jul 23 13:08:51 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\hexarotor_msf.mexw64
...
MODELREF_LINK_RSPFILE     = hexarotor_ref.rsp
COMPILER_COMMAND_FILE     = hexarotor_comp.rsp
CMD_FILE                  = hexarotor.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\hexarotor_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=hexarotor -DNUMST=2 -DNCSTATES=25 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\hexarotor\hexarotor_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = hexarotor_msf.obj c_mexapi_version.obj
...
LDFLAGS_ = /IMPLIB:hexarotor_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:hexarotor_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:hexarotor_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:hexarotor_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
hexarotor_msf.obj : "$(START_DIR)\slprj\sim\hexarotor\hexarotor_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexarotor\hexarotor_msf.c"
