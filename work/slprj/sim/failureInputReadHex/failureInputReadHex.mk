...
## Generated on : Fri Jul 10 11:18:00 2026
...
%.obj : $(START_DIR)/slprj/sim/failureInputReadHex/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/failureInputReadHex/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/failureInputReadHex/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/failureInputReadHex/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/failureInputReadHex/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
