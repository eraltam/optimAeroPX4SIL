...
## Generated on : Thu Jul 23 13:07:14 2026
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = failureInputReadHexlib.lib
...
PRODUCT = .\failureInputReadHexlib.lib
...
SRCS = $(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex.c $(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex_capi.c
...
OBJS = failureInputReadHex.obj failureInputReadHex_capi.obj
...
{$(START_DIR)\slprj\sim\failureInputReadHex}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\failureInputReadHex}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\failureInputReadHex}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\failureInputReadHex}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
failureInputReadHex.obj : "$(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex.c"


failureInputReadHex_capi.obj : "$(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex_capi.c"
