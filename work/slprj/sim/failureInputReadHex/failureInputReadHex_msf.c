...
#define S_FUNCTION_NAME failureInputReadHex_msf
#endif
...
#include "failureInputReadHex.h"
#include "failureInputReadHex_private.h"
...
rt_GetOSigstreamManager ( void ) { return NULL ; } void * rt_slioCatalogue ( void ) { return NULL ; } void * rtwGetPointerFromUniquePtr ( void * uniquePtr ) { return NULL ; } void * CreateDiagnosticAsVoidPtr ( const char * id , int nargs , ... ) { void * voidPtrDiagnostic = NULL ; va_list args ; va_start ( args , nargs ) ; slmrCreateDiagnostic ( id , nargs , args , & voidPtrDiagnostic ) ; va_end ( args ) ; return voidPtrDiagnostic ; } void rt_ssSet_slErrMsg ( void * S , void * diag ) { SimStruct * simStrcut = ( SimStruct * ) S ; if ( ! _ssIsErrorStatusAslErrMsg ( simStrcut ) ) { _ssSet_slLocalErrMsg ( simStrcut , diag ) ; } else { _ssDiscardDiagnostic ( simStrcut , diag ) ; } } void rt_ssReportDiagnosticAsWarning ( void * S , void * diag ) { _ssReportDiagnosticAsWarning ( ( SimStruct * ) S , diag ) ; } void rt_ssReportDiagnosticAsInfo ( void * S , void * diag ) { _ssReportDiagnosticAsInfo ( ( SimStruct * ) S , diag ) ; } const char * rt_CreateFullPathToTop ( const char * toppath , const char * subpath ) { char * fullpath = NULL ; slmrCreateFullPathToTop ( toppath , subpath , & fullpath ) ; return fullpath ; } boolean_T slIsRapidAcceleratorSimulating ( void ) { return false ; } void rt_RAccelReplaceFromFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void rt_RAccelReplaceToFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void * slsa_malloc ( size_t s ) { return malloc ( s ) ; } void slsa_free ( void * ptr ) { free ( ptr ) ; } static void mdlInitializeConditions ( SimStruct * S ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; fpj1bzgggi ( & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; ppjcyknosv ( & ( dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; uint32_T const * i_l54oygjfik = ( uint32_T * ) ssGetInputPortSignal ( S , 1 ) ; EnumHexFailureType const * i_jsobm4bom3 = ( EnumHexFailureType * ) ssGetInputPortSignal ( S , 3 ) ; boolean_T * o_B_1_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; boolean_T * o_B_1_2 = ( boolean_T * ) ssGetOutputPortSignal ( S , 1 ) ; boolean_T * o_B_1_3 = ( boolean_T * ) ssGetOutputPortSignal ( S , 2 ) ; boolean_T * o_B_1_4 = ( boolean_T * ) ssGetOutputPortSignal ( S , 3 ) ; boolean_T * o_B_1_5 = ( boolean_T * ) ssGetOutputPortSignal ( S , 4 ) ; boolean_T * o_B_1_6 = ( boolean_T * ) ssGetOutputPortSignal ( S , 5 ) ; if ( tid == 0 ) { failureInputReadHex ( & ( dw -> rtm ) , i_l54oygjfik , i_jsobm4bom3 , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; h5iepmx1iq ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 4 , 6 ) ; if ( ! ssSetNumInputPorts ( S , 4 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 6 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
...
SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 1 , SS_UINT32 ) ;
...
"EnumHexFailureType" , & dataTypeIdReg ) ; if ( dataTypeIdReg ==
...
ssSetInputPortOffsetTime ( S , 3 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 6
...
, 1 , 0.0 ) ; ssSetOutputPortDiscreteValuedOutput ( S , 1 , 1 ) ;
...
, 2 , 0.0 ) ; ssSetOutputPortDiscreteValuedOutput ( S , 2 , 1 ) ;
...
, 4 , 0.0 ) ; ssSetOutputPortDiscreteValuedOutput ( S , 4 , 1 ) ;
...
mr_failureInputReadHex_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_failureInputReadHex_MdlInfoRegFcn ( S , "failureInputReadHex" , & retVal )
; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( buctytp4xb2 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid == CONSTANT_TID ) { contextTid = 0 ; } simTgtAllocOPModelData ( S ) ; ojggctlbvm ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } kgsh1oahvc ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 )
; uint32_T const * i_l54oygjfik = ( uint32_T * ) ssGetInputPortSignal ( S , 1
) ; EnumHexFailureType const * i_jsobm4bom3 = ( EnumHexFailureType * )
ssGetInputPortSignal ( S , 3 ) ; boolean_T * o_B_1_1 = ( boolean_T * )
ssGetOutputPortSignal ( S , 0 ) ; boolean_T * o_B_1_2 = ( boolean_T * )
ssGetOutputPortSignal ( S , 1 ) ; boolean_T * o_B_1_3 = ( boolean_T * )
ssGetOutputPortSignal ( S , 2 ) ; boolean_T * o_B_1_4 = ( boolean_T * )
ssGetOutputPortSignal ( S , 3 ) ; boolean_T * o_B_1_5 = ( boolean_T * )
ssGetOutputPortSignal ( S , 4 ) ; boolean_T * o_B_1_6 = ( boolean_T * )
ssGetOutputPortSignal ( S , 5 ) ; if ( tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { failureInputReadHex ( & ( dw -> rtm ) , i_l54oygjfik , i_jsobm4bom3 , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; h5iepmx1iq ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; ineffhb1ao ( & ( dw -> rtm ) ) ; simTgtFreeOPModelData ( S ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { buctytp4xb2 * dw =
( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; covkarfzmw ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; }
...
mxArray * mdlrefDW = mr_failureInputReadHex_GetDWork ( ssGetDWork ( S , 0 ) )
; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_failureInputReadHex_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_failureInputReadHex_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
