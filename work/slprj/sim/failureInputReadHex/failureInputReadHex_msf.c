...
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; h5iepmx1iq ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { buctytp4xb2 * dw = ( buctytp4xb2 * ) ssGetDWork ( S , 0 ) ; ineffhb1ao ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_failureInputReadHex_GetDWork ( ssGetDWork ( S , 0 ) ) ;
