...
## Generated on : Thu Jul 23 13:07:16 2026
...
PRODUCT_NAME              = failureInputReadHex
MAKEFILE                  = failureInputReadHex.mk
...
MODELREF_LINK_RSPFILE     = failureInputReadHex_ref.rsp
COMPILER_COMMAND_FILE     = failureInputReadHex_comp.rsp
CMD_FILE                  = failureInputReadHex.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\failureInputReadHex_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=failureInputReadHex -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = failureInputReadHex_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\failureInputReadHex\failureInputReadHexlib.lib
...
LDFLAGS_ = /IMPLIB:failureInputReadHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:failureInputReadHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:failureInputReadHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:failureInputReadHex_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
failureInputReadHex_msf.obj : "$(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\failureInputReadHex\failureInputReadHex_msf.c"
