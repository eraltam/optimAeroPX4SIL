...
## 
## Makefile     : gravity.mk
## Generated on : Thu Jul 23 13:04:27 2026
...
SRCS = $(START_DIR)\slprj\sim\gravity\gravity.c $(START_DIR)\slprj\sim\gravity\gravity_capi.c
...
OBJS = gravity.obj gravity_capi.obj
...
{$(START_DIR)\slprj\sim\gravity}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\gravity}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\gravity}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\gravity}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
gravity.obj : "$(START_DIR)\slprj\sim\gravity\gravity.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\gravity\gravity.c"


gravity_capi.obj : "$(START_DIR)\slprj\sim\gravity\gravity_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\gravity\gravity_capi.c"
