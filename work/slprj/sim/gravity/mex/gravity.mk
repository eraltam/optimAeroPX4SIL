...
## 
## Makefile     : gravity.mk
## Generated on : Thu Jul 23 13:04:29 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\gravity_msf.mexw64
...
MODELREF_LINK_RSPFILE     = gravity_ref.rsp
COMPILER_COMMAND_FILE     = gravity_comp.rsp
CMD_FILE                  = gravity.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\gravity_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=gravity -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\gravity\gravity_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = gravity_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\gravity\gravitylib.lib
...
LDFLAGS_ = /IMPLIB:gravity_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:gravity_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:gravity_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:gravity_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
gravity_msf.obj : "$(START_DIR)\slprj\sim\gravity\gravity_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\gravity\gravity_msf.c"
