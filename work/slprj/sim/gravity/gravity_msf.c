...
ssGetDWork ( S , 0 ) ; ebphgotimp ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_gravity_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber
...
mr_gravity_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1
