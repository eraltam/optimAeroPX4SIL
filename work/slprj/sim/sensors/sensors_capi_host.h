...
childMMI [ 4 ] ; adc_host_DataMapInfo_T child0 ; gps_host_DataMapInfo_T
child1 ; ins_anello_host_DataMapInfo_T child2 ; ins_host_DataMapInfo_T child3
; } sensors_host_DataMapInfo_T ;
#ifdef __cplusplus
extern "C" {
#endif
