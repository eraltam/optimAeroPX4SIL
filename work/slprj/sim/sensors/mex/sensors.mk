...
## 
## Makefile     : sensors.mk
## Generated on : Wed Jul 29 14:20:30 2026
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\sensors_msf.mexw64
...
SRCS = $(START_DIR)\slprj\sim\sensors\sensors_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = sensors_msf.obj c_mexapi_version.obj
...
LDFLAGS_ = /IMPLIB:sensors_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:sensors_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:sensors_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:sensors_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
sensors_msf.obj : "$(START_DIR)\slprj\sim\sensors\sensors_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\sensors\sensors_msf.c"
