...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">cwBlAG4AcwBvAHIAcwAvAGcAcABzAAAA</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAABoDn2UA=</h></hs><causes><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\" pr=\"d\"><arguments><arg type=\"encoded\">ZwBwAHMALwBnAHAAcwBTAGUAbgBzAG8AcgBFAG0AdQBsAGEAdABpAG8AbgBXAGkAdABoAE4AbwBpAHMAZQAAAA==</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAAoCJ10A=</h></hs></diag></causes></diag></diag_root>"
...
-> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { b3bxwyuagcq * dw = ( b3bxwyuagcq * ) ssGetDWork ( S , 0 ) ; ppnzf4flpg ( & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { b3bxwyuagcq * dw = ( b3bxwyuagcq * ) ssGetDWork ( S , 0 ) ; bmwvoaufe2 ( & ( dw -> rtdw ) , & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_sensors_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber
...
mr_sensors_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1
