###########################################################################
## Makefile generated for component 'LocalTerrain'. 
## 
## Makefile     : LocalTerrain.mk
## Generated on : Thu Jul 23 11:16:44 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\LocalTerrain_msf.mexw64
...
MODELREF_LINK_RSPFILE     = LocalTerrain_ref.rsp
COMPILER_COMMAND_FILE     = LocalTerrain_comp.rsp
CMD_FILE                  = LocalTerrain.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\LocalTerrain_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=LocalTerrain -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = LocalTerrain_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\LocalTerrain\LocalTerrainlib.lib
...
LDFLAGS_ = /IMPLIB:LocalTerrain_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:LocalTerrain_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:LocalTerrain_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:LocalTerrain_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
LocalTerrain_msf.obj : "$(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain_msf.c"
