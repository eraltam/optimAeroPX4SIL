...
## Generated on : Thu Jul 23 11:16:42 2026
## Final product: .\LocalTerrainlib.lib
...
SRCS = $(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain.c $(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain_capi.c
...
OBJS = LocalTerrain.obj LocalTerrain_capi.obj
...
{$(START_DIR)\slprj\sim\LocalTerrain}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\LocalTerrain}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\LocalTerrain}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\LocalTerrain}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
LocalTerrain.obj : "$(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain.c"


LocalTerrain_capi.obj : "$(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\LocalTerrain\LocalTerrain_capi.c"
