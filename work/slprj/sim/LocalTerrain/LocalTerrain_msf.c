...
#define S_FUNCTION_NAME LocalTerrain_msf
#endif
...
ssSetInputPortOffsetTime ( S , 8 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 1
...
mr_LocalTerrain_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_LocalTerrain_MdlInfoRegFcn ( S , "LocalTerrain" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( a3tgdgrc1z2 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { a3tgdgrc1z2 * dw = ( a3tgdgrc1z2 * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid == CONSTANT_TID ) { contextTid = 0 ; } simTgtAllocOPModelData ( S ) ; etquuaa4x0 ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { a3tgdgrc1z2 * dw = ( a3tgdgrc1z2 * )
ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_1_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; mdlProcessParameters ( S ) ; n3llx4wcyn ( o_o_o_B_1_1 ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) { a3tgdgrc1z2 * dw = ( a3tgdgrc1z2 * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == PARAMETER_TUNING_TID ) { LocalTerrainTID1 ( o_o_o_B_1_1 ) ; } } static void mdlTerminate ( SimStruct * S ) { a3tgdgrc1z2 * dw = ( a3tgdgrc1z2 * ) ssGetDWork ( S , 0 ) ; nktmhlhgc5 ( & ( dw -> rtm ) ) ; simTgtFreeOPModelData ( S ) ; return ; }
...
mxArray * mdlrefDW = mr_LocalTerrain_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_LocalTerrain_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0
...
mr_LocalTerrain_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0
