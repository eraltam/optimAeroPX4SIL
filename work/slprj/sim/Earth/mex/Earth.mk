###########################################################################
## Makefile generated for component 'Earth'. 
## 
## Makefile     : Earth.mk
## Generated on : Wed Jul 29 14:13:13 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Earth_msf.mexw64
...
MODELREF_LINK_RSPFILE     = Earth_ref.rsp
COMPILER_COMMAND_FILE     = Earth_comp.rsp
CMD_FILE                  = Earth.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Earth_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=Earth -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\Earth\Earth_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = Earth_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\Earth\Earthlib.lib
...
LDFLAGS_ = /IMPLIB:Earth_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:Earth_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:Earth_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:Earth_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
Earth_msf.obj : "$(START_DIR)\slprj\sim\Earth\Earth_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\Earth\Earth_msf.c"
