...
## 
## Makefile     : Earth.mk
## Generated on : Thu Jul 23 11:16:21 2026
## Final product: .\Earthlib.lib
...
SRCS = $(START_DIR)\slprj\sim\Earth\Earth.c $(START_DIR)\slprj\sim\Earth\Earth_capi.c
...
{$(START_DIR)\slprj\sim\Earth}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\Earth}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\Earth}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\Earth}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Earth.obj : "$(START_DIR)\slprj\sim\Earth\Earth.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\Earth\Earth.c"


Earth_capi.obj : "$(START_DIR)\slprj\sim\Earth\Earth_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\Earth\Earth_capi.c"
