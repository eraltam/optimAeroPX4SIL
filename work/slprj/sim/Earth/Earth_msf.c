...
#define S_FUNCTION_NAME Earth_msf
#endif
...
real_T rtP_referenceAltitude_m ; real_T rtP_referenceDecimalYear_years ;
...
static void mdlProcessParameters ( SimStruct * S ) { real_T * GlobalPrm_0 = ( real_T * ) NULL ; real_T * GlobalPrm_1 = ( real_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_referenceAltitude_m ) , GlobalPrm_0 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP_referenceDecimalYear_years ) , GlobalPrm_1 , sizeof ( real_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { kzo2mbsde2x * dw = ( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; h0xamgxegy ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { kzo2mbsde2x * dw = ( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; hhmbei1r1d ( & ( dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { kzo2mbsde2x * dw = ( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; real_T const * i_mh2uheldjx = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T * o_B_26_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_26_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_26_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; if ( tid == 0 ) { Earth ( & ( dw -> rtm ) , i_mh2uheldjx , o_B_26_1 , o_B_26_2 , o_B_26_3 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; cnzfydxze0 ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 9 , 3 ) ; if ( ! ssSetNumInputPorts ( S , 9 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 3 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
ssSetInputPortOffsetTime ( S , 8 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3
...
mr_Earth_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 ) ;
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_Earth_MdlInfoRegFcn ( S
, "Earth" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( kzo2mbsde2x ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { kzo2mbsde2x * dw = ( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid == CONSTANT_TID ) { contextTid = 0 ; } simTgtAllocOPModelData ( S ) ; o1evou4ho2 ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } fgj5iijlyx ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mdlProcessParameters ( S ) ; }
#define RTW_GENERATED_DISABLE
static void mdlDisable ( SimStruct * S ) { kzo2mbsde2x * dw = ( kzo2mbsde2x *
) ssGetDWork ( S , 0 ) ; jvoajx2hic ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ;
return ; } static void mdlOutputs ( SimStruct * S , int_T tid ) { kzo2mbsde2x
* dw = ( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; real_T const * i_mh2uheldjx =
( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T * o_B_26_1 = ( real_T *
) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_26_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_26_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; if ( tid == PARAMETER_TUNING_TID ) {
EarthTID1 ( & ( dw -> rtb ) ) ; } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { Earth ( & ( dw -> rtm ) , i_mh2uheldjx , o_B_26_1 ,
o_B_26_2 , o_B_26_3 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { kzo2mbsde2x * dw = ( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; cnzfydxze0 ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { kzo2mbsde2x * dw = ( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; gyaf1bhjum ( & ( dw -> rtm ) ) ; simTgtFreeOPModelData ( S ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { kzo2mbsde2x * dw =
( kzo2mbsde2x * ) ssGetDWork ( S , 0 ) ; a0favbk2uu ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; }
...
mxArray * mdlrefDW = mr_Earth_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_Earth_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 , 2 ,
...
simTgtDeserializeVoidMemoryOP ( S , voidMemData ) ; } mr_Earth_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1 ) ) ; ssSetTNext ( S , ( time_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 3 ) ) ) ; ssSetTNextTid ( S , ( int_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 4 ) ) ) ; }
