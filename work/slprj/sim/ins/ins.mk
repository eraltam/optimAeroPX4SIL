...
## 
## Makefile     : ins.mk
## Generated on : Wed Jul 29 14:16:47 2026
## Final product: .\inslib.lib
...
SRCS = $(START_DIR)\slprj\sim\ins\ins.c $(START_DIR)\slprj\sim\ins\ins_capi.c
...
{$(START_DIR)\slprj\sim\ins}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\ins}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\ins}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\ins}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ins.obj : "$(START_DIR)\slprj\sim\ins\ins.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\ins\ins.c"


ins_capi.obj : "$(START_DIR)\slprj\sim\ins\ins_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\ins\ins_capi.c"
