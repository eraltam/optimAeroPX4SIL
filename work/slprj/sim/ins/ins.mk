...
## 
## Makefile     : ins.mk
## Generated on : Wed Jul 29 03:56:33 2026
...
%.obj : $(START_DIR)/slprj/sim/ins/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/ins/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/ins/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/ins/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/ins/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
