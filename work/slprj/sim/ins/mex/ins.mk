...
## 
## Makefile     : ins.mk
## Generated on : Wed Jul 29 14:16:49 2026
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ins_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=ins -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\ins\ins_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = ins_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\Users\EDISON~1\SITLV2\ANELLO~1\OPTIMA~1\work\slprj\sim\ins\inslib.lib
...
LDFLAGS_ = /IMPLIB:ins_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:ins_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:ins_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:ins_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
ins_msf.obj : "$(START_DIR)\slprj\sim\ins\ins_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\ins\ins_msf.c"
