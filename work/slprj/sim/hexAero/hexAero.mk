...
## 
## Makefile     : hexAero.mk
## Generated on : Mon Jul 13 14:41:42 2026
...
%.obj : $(START_DIR)/slprj/sim/hexAero/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexAero/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexAero/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexAero/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexAero/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
