...
## 
## Makefile     : hexAero.mk
## Generated on : Thu Jul 23 13:08:11 2026
## Final product: .\hexAerolib.lib
...
SRCS = $(START_DIR)\slprj\sim\hexAero\hexAero.c $(START_DIR)\slprj\sim\hexAero\hexAero_capi.c
...
OBJS = hexAero.obj hexAero_capi.obj
...
{$(START_DIR)\slprj\sim\hexAero}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAero}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAero}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAero}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
hexAero.obj : "$(START_DIR)\slprj\sim\hexAero\hexAero.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAero\hexAero.c"


hexAero_capi.obj : "$(START_DIR)\slprj\sim\hexAero\hexAero_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAero\hexAero_capi.c"
