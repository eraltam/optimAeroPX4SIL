###########################################################################
## Makefile generated for component 'hexAero'. 
## 
## Makefile     : hexAero.mk
## Generated on : Thu Jul 23 13:08:13 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\hexAero_msf.mexw64
...
MODELREF_LINK_RSPFILE     = hexAero_ref.rsp
COMPILER_COMMAND_FILE     = hexAero_comp.rsp
CMD_FILE                  = hexAero.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\hexAero_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=hexAero -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\hexAero\hexAero_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = hexAero_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\hexAero\hexAerolib.lib C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModellib.lib
...
LDFLAGS_ = /IMPLIB:hexAero_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:hexAero_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:hexAero_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:hexAero_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
hexAero_msf.obj : "$(START_DIR)\slprj\sim\hexAero\hexAero_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAero\hexAero_msf.c"
