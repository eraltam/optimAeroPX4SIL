...
mdlrefDW = mr_hexAero_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber
...
mr_hexAero_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1
