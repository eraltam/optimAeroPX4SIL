...
## Generated on : Thu Jul 23 13:07:42 2026
...
{$(START_DIR)\slprj\sim\hexActuator}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexActuator}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexActuator}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexActuator}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
hexActuator.obj : "$(START_DIR)\slprj\sim\hexActuator\hexActuator.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexActuator\hexActuator.c"


hexActuator_capi.obj : "$(START_DIR)\slprj\sim\hexActuator\hexActuator_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexActuator\hexActuator_capi.c"
