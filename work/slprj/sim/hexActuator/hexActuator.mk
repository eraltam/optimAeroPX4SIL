...
SRCS = $(START_DIR)/slprj/sim/hexActuator/hexActuator.c $(START_DIR)/slprj/sim/hexActuator/hexActuator_capi.c
...
OBJS = hexActuator.obj hexActuator_capi.obj
...
MODELREF_LIBS = C:/Users/EDISON~1/DOCUME~1/ANELLO~1/OPTIMA~1/work/slprj/sim/HEXMOT~1/HEXMOT~1.LIB
...
%.obj : $(START_DIR)/slprj/sim/hexActuator/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexActuator/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexActuator/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexActuator/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/hexActuator/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
hexActuator.obj : $(START_DIR)/slprj/sim/hexActuator/hexActuator.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hexActuator_capi.obj : $(START_DIR)/slprj/sim/hexActuator/hexActuator_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
