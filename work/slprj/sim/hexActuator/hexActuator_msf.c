...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { phqu2wcoxqx * dw = ( phqu2wcoxqx * ) ssGetDWork ( S , 0 ) ; c1n3c5jiq0 * localX = ( c1n3c5jiq0 * ) ssGetContStates ( S ) ; isfesx5c5f ( & ( dw -> rtdw ) , localX ) ; } static void mdlReset ( SimStruct * S ) { phqu2wcoxqx * dw = ( phqu2wcoxqx * ) ssGetDWork ( S , 0 ) ; c1n3c5jiq0 * localX = ( c1n3c5jiq0 * ) ssGetContStates ( S ) ; l01m5oasi2 ( & ( dw -> rtdw ) , localX ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { phqu2wcoxqx * dw = ( phqu2wcoxqx * ) ssGetDWork ( S , 0 ) ; real_T const * i_k3wkn0m1e0 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_hwlktx53ng = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_lt20nrysbp = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_mpq5kvgtx1 = ( real_T * ) ssGetInputPortSignal ( S , 12 ) ; boolean_T const * i_a5ybkp3x2n = ( boolean_T * ) ssGetInputPortSignal ( S , 19 ) ; boolean_T const * i_efs040tzjn = ( boolean_T * ) ssGetInputPortSignal ( S , 20 ) ; real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_1_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; c1n3c5jiq0 * localX = ( c1n3c5jiq0 * ) ssGetContStates ( S ) ; if ( tid == 0 ) { hexActuator ( i_k3wkn0m1e0 , i_hwlktx53ng , i_lt20nrysbp , i_mpq5kvgtx1 , i_a5ybkp3x2n , i_efs040tzjn , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; mlabmlngdd ( & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 4 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetNumPeriodicContStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 21 , 5 ) ; if ( ! ssSetNumInputPorts ( S , 21 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
5 ) ) return ; if ( ! ssSetOutputPortVectorDimension ( S , 0 , 1 ) ) return ;
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { phqu2wcoxqx * dw = ( phqu2wcoxqx * ) ssGetDWork ( S , 0 ) ; c1n3c5jiq0 * localX = ( c1n3c5jiq0 * ) ssGetContStates ( S ) ; ssNonContDerivSigFeedingOutports mr_nonContOutput0 [ 4 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput1 [ 4 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput2 [ 4 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput3 [ 4 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput4 [ 4 ] ; ssNonContDerivSigFeedingOutports * mr_nonContOutputArray [ 5 ] ; void * sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid == CONSTANT_TID ) { contextTid = 0 ; } mr_nonContOutputArray [ 0 ] = mr_nonContOutput0 ; mr_nonContOutputArray [ 1 ] = mr_nonContOutput1 ; mr_nonContOutputArray [ 2 ] = mr_nonContOutput2 ; mr_nonContOutputArray [ 3 ] = mr_nonContOutput3 ; mr_nonContOutputArray [ 4 ] = mr_nonContOutput4 ; simTgtAllocOPModelData ( S ) ; aoked5yefw ( S , mr_nonContOutputArray , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 2 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 0 , mr_nonContOutput0 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 1 , mr_nonContOutput1 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 2 , mr_nonContOutput2 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 3 , mr_nonContOutput3 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 4 , mr_nonContOutput4 ) ) return ; } ehudmthbfy ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
...
i_mpq5kvgtx1 = ( real_T * ) ssGetInputPortSignal ( S , 12 ) ; boolean_T const
* i_a5ybkp3x2n = ( boolean_T * ) ssGetInputPortSignal ( S , 19 ) ; boolean_T
const * i_efs040tzjn = ( boolean_T * ) ssGetInputPortSignal ( S , 20 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_1_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; c1n3c5jiq0 * localX = ( c1n3c5jiq0 * ) ssGetContStates ( S ) ; if ( tid == PARAMETER_TUNING_TID ) { hexActuatorTID2 ( & ( dw -> rtdw ) ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) { hexActuator ( i_k3wkn0m1e0 , i_hwlktx53ng , i_lt20nrysbp , i_mpq5kvgtx1 , i_a5ybkp3x2n , i_efs040tzjn , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
