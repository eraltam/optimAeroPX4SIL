...
## Generated on : Thu Jul 23 13:07:44 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\hexActuator_msf.mexw64
...
MODELREF_LINK_RSPFILE     = hexActuator_ref.rsp
COMPILER_COMMAND_FILE     = hexActuator_comp.rsp
CMD_FILE                  = hexActuator.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\hexActuator_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=hexActuator -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\hexActuator\hexActuator_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = hexActuator_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\hexActuator\hexActuatorlib.lib C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\hexMotorModel\hexMotorModellib.lib
...
LDFLAGS_ = /IMPLIB:hexActuator_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:hexActuator_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:hexActuator_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:hexActuator_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
hexActuator_msf.obj : "$(START_DIR)\slprj\sim\hexActuator\hexActuator_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexActuator\hexActuator_msf.c"
