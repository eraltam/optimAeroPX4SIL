...
## Generated on : Thu Jul 09 17:10:32 2026
...
%.obj : $(START_DIR)/slprj/sim/inertialDynamics/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/inertialDynamics/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/inertialDynamics/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/inertialDynamics/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/inertialDynamics/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
