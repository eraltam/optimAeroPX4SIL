...
## Generated on : Thu Jul 23 13:06:53 2026
## Final product: .\inertialDynamicslib.lib
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = inertialDynamicslib.lib
...
PRODUCT = .\inertialDynamicslib.lib
...
SRCS = $(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics.c $(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics_capi.c
...
OBJS = inertialDynamics.obj inertialDynamics_capi.obj
...
{$(START_DIR)\slprj\sim\inertialDynamics}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\inertialDynamics}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\inertialDynamics}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\inertialDynamics}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
inertialDynamics.obj : "$(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics.c"


inertialDynamics_capi.obj : "$(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics_capi.c"
