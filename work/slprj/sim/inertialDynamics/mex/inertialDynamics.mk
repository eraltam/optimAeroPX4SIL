###########################################################################
## Makefile generated for component 'inertialDynamics'. 
## 
## Makefile     : inertialDynamics.mk
## Generated on : Thu Jul 23 13:06:55 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\inertialDynamics_msf.mexw64
...
MODELREF_LINK_RSPFILE     = inertialDynamics_ref.rsp
COMPILER_COMMAND_FILE     = inertialDynamics_comp.rsp
CMD_FILE                  = inertialDynamics.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\inertialDynamics_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=inertialDynamics -DNUMST=2 -DNCSTATES=13 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = inertialDynamics_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\inertialDynamics\inertialDynamicslib.lib
...
LDFLAGS_ = /IMPLIB:inertialDynamics_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:inertialDynamics_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:inertialDynamics_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:inertialDynamics_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
inertialDynamics_msf.obj : "$(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\inertialDynamics\inertialDynamics_msf.c"
