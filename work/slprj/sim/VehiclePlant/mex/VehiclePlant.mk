...
## Generated on : Thu Jul 23 13:43:26 2026
...
MODELREF_LINK_RSPFILE     = VehiclePlant_ref.rsp
COMPILER_COMMAND_FILE     = VehiclePlant_comp.rsp
CMD_FILE                  = VehiclePlant.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\VehiclePlant_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=VehiclePlant -DNUMST=3 -DNCSTATES=25 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=1
...
SRCS = $(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = VehiclePlant_msf.obj c_mexapi_version.obj
...
SYSTEM_LIBS = /LIBPATH:"$(MATLAB_ROOT)\extern\lib\win64\microsoft" "$(MW_LIB_DIR)\libmwipp.lib" "$(MW_EXTERNLIB_DIR)\libmwipp.lib" "$(MW_EXTERNLIB_DIR)\libfixedpoint.lib" "$(MW_EXTERNLIB_DIR)\libmwmathutil.lib" "$(MW_EXTERNLIB_DIR)\libmwsl_AsyncioQueue.lib" "$(MW_EXTERNLIB_DIR)\sf_runtime.lib" "$(MW_EXTERNLIB_DIR)\libmwslexec_simlog.lib" "$(MW_EXTERNLIB_DIR)\libmwcoder_ToAsyncQueueTgtAppSvc.lib" "$(MW_EXTERNLIB_DIR)\libmwsl_simtarget_instrumentation.lib" "$(MW_EXTERNLIB_DIR)\libmwsl_simtarget_core.lib" "$(MW_EXTERNLIB_DIR)\libmwsl_sfcn_loader.lib" "$(MW_EXTERNLIB_DIR)\libmwstringutil.lib" "$(MW_EXTERNLIB_DIR)\libemlrt.lib" "$(MW_EXTERNLIB_DIR)\libmx.lib" "$(MW_EXTERNLIB_DIR)\libmex.lib"
...
LDFLAGS_ = /IMPLIB:VehiclePlant_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:VehiclePlant_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:VehiclePlant_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:VehiclePlant_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
VehiclePlant_msf.obj : "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_msf.c"
