...
rtP_vehicle ; real_T rtP_C_D [ 19 ] ; real_T rtP_C_L [ 19 ] ; real_T
rtP_INS_VARIANT ; real_T rtP_WIND_SOURCE ; real_T rtP_actuatorDelay_s ;
...
[ 3 ] ; real_T rtP_alphaBkpts_rad [ 19 ] ; real_T
rtP_anelloSiPhOGTemperatureCounts ; real_T rtP_gustAmplitude_mps [ 3 ] ;
real_T rtP_gustDuration_sec ; real_T rtP_gustLength_m [ 3 ] ; real_T
rtP_gustStartTime_sec ; real_T rtP_referenceAltitude_m ; real_T
rtP_referenceDecimalYear_years ; real_T rtP_rpm2radps ; real_T
...
boolean_T rtP_turbulenceEnabled ; uint8_T rtP_anelloOutputMode ; const char *
...
* ) NULL ; struct_EwMtsSUDbGvLjUwS89lioH * GlobalPrm_1 = ( struct_EwMtsSUDbGvLjUwS89lioH * ) NULL ; real_T * GlobalPrm_2 = ( real_T * ) NULL ; real_T * GlobalPrm_3 = ( real_T * ) NULL ; real_T * GlobalPrm_4 = ( real_T * ) NULL ; real_T * GlobalPrm_5 = ( real_T * ) NULL ; real_T * GlobalPrm_6 = ( real_T * ) NULL ; real_T * GlobalPrm_7 = ( real_T * ) NULL ; real_T * GlobalPrm_8 = ( real_T * ) NULL ; real_T * GlobalPrm_9 = ( real_T * ) NULL ; real_T * GlobalPrm_10 = ( real_T * ) NULL ; real_T * GlobalPrm_11 = ( real_T * ) NULL ; real_T * GlobalPrm_12 = ( real_T * ) NULL ; real_T * GlobalPrm_13 = ( real_T * ) NULL ; real_T * GlobalPrm_14 = ( real_T * ) NULL ; real_T * GlobalPrm_15 = ( real_T * ) NULL ; real_T * GlobalPrm_16 = ( real_T * ) NULL ; real_T * GlobalPrm_17 = ( real_T * ) NULL ; real_T * GlobalPrm_18 = ( real_T * ) NULL ; real_T * GlobalPrm_19 = ( real_T * ) NULL ; real_T * GlobalPrm_20 = ( real_T * ) NULL ; real_T * GlobalPrm_21 = ( real_T * ) NULL ; real_T * GlobalPrm_22 = ( real_T * ) NULL ; real_T * GlobalPrm_23 = ( real_T * ) NULL ; real_T * GlobalPrm_24 = ( real_T * ) NULL ; real_T * GlobalPrm_25 = ( real_T * ) NULL ; real_T * GlobalPrm_26 = ( real_T * ) NULL ; real_T * GlobalPrm_27 = ( real_T * ) NULL ; real_T * GlobalPrm_28 = ( real_T * ) NULL ; boolean_T * GlobalPrm_29 = ( boolean_T * ) NULL ; boolean_T * GlobalPrm_30 = ( boolean_T * ) NULL ; uint8_T * GlobalPrm_31 = ( uint8_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_parameters ) , GlobalPrm_0 , sizeof ( struct_7BigaldNWGj33rb8sElmtH ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP_vehicle ) , GlobalPrm_1 , sizeof ( struct_EwMtsSUDbGvLjUwS89lioH ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & ( rtP_C_D [ 0 ] ) , GlobalPrm_2 , sizeof ( real_T ) * 19 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 3 , ( void * * ) ( & GlobalPrm_3 ) ) ) return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy ( & ( rtP_C_L [ 0 ] ) , GlobalPrm_3 , sizeof ( real_T ) * 19 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 4 , ( void * * ) ( & GlobalPrm_4 ) ) ) return ; if ( GlobalPrm_4 != NULL ) { ( void ) memcpy ( & ( rtP_INS_VARIANT ) , GlobalPrm_4 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 5 , ( void * * ) ( & GlobalPrm_5 ) ) ) return ; if ( GlobalPrm_5 != NULL ) { ( void ) memcpy ( & ( rtP_WIND_SOURCE ) , GlobalPrm_5 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 6 , ( void * * ) ( & GlobalPrm_6 ) ) ) return ; if ( GlobalPrm_6 != NULL ) { ( void ) memcpy ( & ( rtP_actuatorDelay_s ) , GlobalPrm_6 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 7 , ( void * * ) ( & GlobalPrm_7 ) ) ) return ; if ( GlobalPrm_7 != NULL ) { ( void ) memcpy ( & ( rtP_airDensityAtStd_kgpm3 ) , GlobalPrm_7 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 8 , ( void * * ) ( & GlobalPrm_8 ) ) ) return ; if ( GlobalPrm_8 != NULL ) { ( void ) memcpy ( & ( rtP_aircraftInitialBodyRates_radps [ 0 ] ) , GlobalPrm_8 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 9 , ( void * * ) ( & GlobalPrm_9 ) ) ) return ; if ( GlobalPrm_9 != NULL ) { ( void ) memcpy ( & ( rtP_aircraftInitialEuler_rad [ 0 ] ) , GlobalPrm_9 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 10 , ( void * * ) ( & GlobalPrm_10 ) ) ) return ; if ( GlobalPrm_10 != NULL ) { ( void ) memcpy ( & ( rtP_aircraftInitialPosInNED_m [ 0 ] ) , GlobalPrm_10 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 11 , ( void * * ) ( & GlobalPrm_11 ) ) ) return ; if ( GlobalPrm_11 != NULL ) { ( void ) memcpy ( & ( rtP_aircraftInitialVelInBody_mps [ 0 ] ) , GlobalPrm_11 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 12 , ( void * * ) ( & GlobalPrm_12 ) ) ) return ; if ( GlobalPrm_12 != NULL ) { ( void ) memcpy ( & ( rtP_alphaBkpts_rad [ 0 ] ) , GlobalPrm_12 , sizeof ( real_T ) * 19 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 13 , ( void * * ) ( & GlobalPrm_13 ) ) ) return ; if ( GlobalPrm_13 != NULL ) { ( void ) memcpy ( & ( rtP_anelloSiPhOGTemperatureCounts ) , GlobalPrm_13 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 14 , ( void * * ) ( & GlobalPrm_14 ) ) ) return ; if ( GlobalPrm_14 != NULL ) { ( void ) memcpy ( & ( rtP_gustAmplitude_mps [ 0 ] ) , GlobalPrm_14 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 15 , ( void * * ) ( & GlobalPrm_15 ) ) ) return ; if ( GlobalPrm_15 != NULL ) { ( void ) memcpy ( & ( rtP_gustDuration_sec ) , GlobalPrm_15 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 16 , ( void * * ) ( & GlobalPrm_16 ) ) ) return ; if ( GlobalPrm_16 != NULL ) { ( void ) memcpy ( & ( rtP_gustLength_m [ 0 ] ) , GlobalPrm_16 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 17 , ( void * * ) ( & GlobalPrm_17 ) ) ) return ; if ( GlobalPrm_17 != NULL ) { ( void ) memcpy ( & ( rtP_gustStartTime_sec ) , GlobalPrm_17 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 18 , ( void * * ) ( & GlobalPrm_18 ) ) ) return ; if ( GlobalPrm_18 != NULL ) { ( void ) memcpy ( & ( rtP_referenceAltitude_m ) , GlobalPrm_18 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 19 , ( void * * ) ( & GlobalPrm_19 ) ) ) return ; if ( GlobalPrm_19 != NULL ) { ( void ) memcpy ( & ( rtP_referenceDecimalYear_years ) , GlobalPrm_19 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 20 , ( void * * ) ( & GlobalPrm_20 ) ) ) return ; if ( GlobalPrm_20 != NULL ) { ( void ) memcpy ( & ( rtP_rpm2radps ) , GlobalPrm_20 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 21 , ( void * * ) ( & GlobalPrm_21 ) ) ) return ; if ( GlobalPrm_21 != NULL ) { ( void ) memcpy ( & ( rtP_terrainHeightNED_m ) , GlobalPrm_21 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 22 , ( void * * ) ( & GlobalPrm_22 ) ) ) return ; if ( GlobalPrm_22 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceEndTime_sec ) , GlobalPrm_22 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 23 , ( void * * ) ( & GlobalPrm_23 ) ) ) return ; if ( GlobalPrm_23 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceMinAirspeed_mps ) , GlobalPrm_23 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 24 , ( void * * ) ( & GlobalPrm_24 ) ) ) return ; if ( GlobalPrm_24 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceStartTime_sec ) , GlobalPrm_24 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 25 , ( void * * ) ( & GlobalPrm_25 ) ) ) return ; if ( GlobalPrm_25 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceWingspan_m ) , GlobalPrm_25 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 26 , ( void * * ) ( & GlobalPrm_26 ) ) ) return ; if ( GlobalPrm_26 != NULL ) { ( void ) memcpy ( & ( rtP_xWindInNED_mps ) , GlobalPrm_26 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 27 , ( void * * ) ( & GlobalPrm_27 ) ) ) return ; if ( GlobalPrm_27 != NULL ) { ( void ) memcpy ( & ( rtP_yWindInNED_mps ) , GlobalPrm_27 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 28 , ( void * * ) ( & GlobalPrm_28 ) ) ) return ; if ( GlobalPrm_28 != NULL ) { ( void ) memcpy ( & ( rtP_zWindInNED_mps ) , GlobalPrm_28 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 29 , ( void * * ) ( & GlobalPrm_29 ) ) ) return ; if ( GlobalPrm_29 != NULL ) { ( void ) memcpy ( & ( rtP_gustEnabled ) , GlobalPrm_29 , sizeof ( boolean_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 30 , ( void * * ) ( & GlobalPrm_30 ) ) ) return ; if ( GlobalPrm_30 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceEnabled ) , GlobalPrm_30 , sizeof ( boolean_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 31 , ( void * * ) ( & GlobalPrm_31 ) ) ) return ; if ( GlobalPrm_31 != NULL ) { ( void ) memcpy ( & ( rtP_anelloOutputMode ) , GlobalPrm_31 , sizeof ( uint8_T ) ) ; } }
#endif
...
ssSetOutputPortOkToMerge ( S , 73 , SS_NOT_OK_TO_MERGE ) ;
...
ssSetOutputPortOkToMerge ( S , 74 , SS_NOT_OK_TO_MERGE ) ;
...
ssSetOutputPortOkToMerge ( S , 75 , SS_NOT_OK_TO_MERGE ) ;
...
ssSetOutputPortOkToMerge ( S , 76 , SS_NOT_OK_TO_MERGE ) ;
...
ssSetOutputPortOkToMerge ( S , 77 , SS_NOT_OK_TO_MERGE ) ;
...
ssSetOutputPortOkToMerge ( S , 78 , SS_NOT_OK_TO_MERGE ) ;
...
ssSetOutputPortOkToMerge ( S , 79 , SS_NOT_OK_TO_MERGE ) ;
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">VgBlAGgAaQBjAGwAZQBQAGwAYQBuAHQALwBlAG4AdgBpAHIAbwBuAG0AZQBuAHQAAAA=</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAH+Bg4EA=</h></hs><causes><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">ZQBuAHYAaQByAG8AbgBtAGUAbgB0AC8AZQBhAHIAdABoAAAA</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAgIDry0A=</h></hs><causes><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\" pr=\"d\"><arguments><arg type=\"encoded\">RQBhAHIAdABoAC8AVwBHAFMAOAA0ACAARwByAGEAdgBpAHQAeQAgAE0AbwBkAGUAbAAgACAAAAA=</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAgIDry0A=</h></hs></diag></causes></diag></causes></diag></diag_root>"
