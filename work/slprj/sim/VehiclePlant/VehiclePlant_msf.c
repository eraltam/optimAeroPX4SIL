...
struct_7BigaldNWGj33rb8sElmtH rtP_parameters ; real_T rtP_INS_VARIANT ;
real_T rtP_actuatorDelay_s ; real_T rtP_gustAmplitude_mps [ 3 ] ; real_T
rtP_gustDuration_sec ; real_T rtP_gustLength_m [ 3 ] ; real_T
rtP_gustStartTime_sec ; real_T rtP_plantSampleTime_s ; real_T
rtP_referenceAltitude_m ; real_T rtP_referenceDecimalYear_years ; real_T
rtP_referenceLatitude_deg ; real_T rtP_referenceLongitude_deg ; real_T
rtP_terrainHeightNED_m ; real_T rtP_turbulenceEndTime_sec ; real_T
rtP_turbulenceMinAirspeed_mps ; real_T rtP_turbulenceStartTime_sec ; real_T
rtP_turbulenceWingspan_m ; real_T rtP_xWindInNED_mps ; real_T
rtP_yWindInNED_mps ; real_T rtP_zWindInNED_mps ; boolean_T rtP_gustEnabled ;
boolean_T rtP_turbulenceEnabled ; extern const lywj54ogohf mdaxxes2p3 ; const
char * rt_GetMatSignalLoggingFileName ( void ) { return NULL ; } const char *
rt_GetMatSigLogSelectorFileName ( void ) { return NULL ; } void *
rt_GetOSigstreamManager ( void ) { return NULL ; } void * rt_slioCatalogue ( void ) { return NULL ; } void * rtwGetPointerFromUniquePtr ( void * uniquePtr ) { return NULL ; } void * CreateDiagnosticAsVoidPtr ( const char * id , int nargs , ... ) { void * voidPtrDiagnostic = NULL ; va_list args ; va_start ( args , nargs ) ; slmrCreateDiagnostic ( id , nargs , args , & voidPtrDiagnostic ) ; va_end ( args ) ; return voidPtrDiagnostic ; } void rt_ssSet_slErrMsg ( void * S , void * diag ) { SimStruct * simStrcut = ( SimStruct * ) S ; if ( ! _ssIsErrorStatusAslErrMsg ( simStrcut ) ) { _ssSet_slLocalErrMsg ( simStrcut , diag ) ; } else { _ssDiscardDiagnostic ( simStrcut , diag ) ; } } void rt_ssReportDiagnosticAsWarning ( void * S , void * diag ) { _ssReportDiagnosticAsWarning ( ( SimStruct * ) S , diag ) ; } void rt_ssReportDiagnosticAsInfo ( void * S , void * diag ) { _ssReportDiagnosticAsInfo ( ( SimStruct * ) S , diag ) ; } const char * rt_CreateFullPathToTop ( const char * toppath , const char * subpath ) { char * fullpath = NULL ; slmrCreateFullPathToTop ( toppath , subpath , & fullpath ) ; return fullpath ; } boolean_T slIsRapidAcceleratorSimulating ( void ) { return false ; } void rt_RAccelReplaceFromFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void rt_RAccelReplaceToFilename ( SimStruct * S , const char * blockpath , char * fileName ) { ( void ) blockpath ; ( void ) fileName ; } void * slsa_malloc ( size_t s ) { return malloc ( s ) ; } void slsa_free ( void * ptr ) { free ( ptr ) ; } void JSBSim_SFunction ( SimStruct * S ) { ( void ) S ; }
...
) NULL ; real_T * GlobalPrm_8 = ( real_T * ) NULL ; real_T * GlobalPrm_9 = ( real_T * ) NULL ; real_T * GlobalPrm_10 = ( real_T * ) NULL ; real_T * GlobalPrm_11 = ( real_T * ) NULL ; real_T * GlobalPrm_12 = ( real_T * ) NULL ; real_T * GlobalPrm_13 = ( real_T * ) NULL ; real_T * GlobalPrm_14 = ( real_T * ) NULL ; real_T * GlobalPrm_15 = ( real_T * ) NULL ; real_T * GlobalPrm_16 = ( real_T * ) NULL ; real_T * GlobalPrm_17 = ( real_T * ) NULL ; real_T * GlobalPrm_18 = ( real_T * ) NULL ; real_T * GlobalPrm_19 = ( real_T * ) NULL ; boolean_T * GlobalPrm_20 = ( boolean_T * ) NULL ; boolean_T * GlobalPrm_21 = ( boolean_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_parameters ) , GlobalPrm_0 , sizeof ( struct_7BigaldNWGj33rb8sElmtH ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP_INS_VARIANT ) , GlobalPrm_1 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & ( rtP_actuatorDelay_s ) , GlobalPrm_2 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 3 , ( void * * ) ( & GlobalPrm_3 ) ) ) return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy ( & ( rtP_gustAmplitude_mps [ 0 ] ) , GlobalPrm_3 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 4 , ( void * * ) ( & GlobalPrm_4 ) ) ) return ; if ( GlobalPrm_4 != NULL ) { ( void ) memcpy ( & ( rtP_gustDuration_sec ) , GlobalPrm_4 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 5 , ( void * * ) ( & GlobalPrm_5 ) ) ) return ; if ( GlobalPrm_5 != NULL ) { ( void ) memcpy ( & ( rtP_gustLength_m [ 0 ] ) , GlobalPrm_5 , sizeof ( real_T ) * 3 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 6 , ( void * * ) ( & GlobalPrm_6 ) ) ) return ; if ( GlobalPrm_6 != NULL ) { ( void ) memcpy ( & ( rtP_gustStartTime_sec ) , GlobalPrm_6 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 7 , ( void * * ) ( & GlobalPrm_7 ) ) ) return ; if ( GlobalPrm_7 != NULL ) { ( void ) memcpy ( & ( rtP_plantSampleTime_s ) , GlobalPrm_7 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 8 , ( void * * ) ( & GlobalPrm_8 ) ) ) return ; if ( GlobalPrm_8 != NULL ) { ( void ) memcpy ( & ( rtP_referenceAltitude_m ) , GlobalPrm_8 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 9 , ( void * * ) ( & GlobalPrm_9 ) ) ) return ; if ( GlobalPrm_9 != NULL ) { ( void ) memcpy ( & ( rtP_referenceDecimalYear_years ) , GlobalPrm_9 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 10 , ( void * * ) ( & GlobalPrm_10 ) ) ) return ; if ( GlobalPrm_10 != NULL ) { ( void ) memcpy ( & ( rtP_referenceLatitude_deg ) , GlobalPrm_10 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 11 , ( void * * ) ( & GlobalPrm_11 ) ) ) return ; if ( GlobalPrm_11 != NULL ) { ( void ) memcpy ( & ( rtP_referenceLongitude_deg ) , GlobalPrm_11 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 12 , ( void * * ) ( & GlobalPrm_12 ) ) ) return ; if ( GlobalPrm_12 != NULL ) { ( void ) memcpy ( & ( rtP_terrainHeightNED_m ) , GlobalPrm_12 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 13 , ( void * * ) ( & GlobalPrm_13 ) ) ) return ; if ( GlobalPrm_13 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceEndTime_sec ) , GlobalPrm_13 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 14 , ( void * * ) ( & GlobalPrm_14 ) ) ) return ; if ( GlobalPrm_14 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceMinAirspeed_mps ) , GlobalPrm_14 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 15 , ( void * * ) ( & GlobalPrm_15 ) ) ) return ; if ( GlobalPrm_15 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceStartTime_sec ) , GlobalPrm_15 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 16 , ( void * * ) ( & GlobalPrm_16 ) ) ) return ; if ( GlobalPrm_16 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceWingspan_m ) , GlobalPrm_16 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 17 , ( void * * ) ( & GlobalPrm_17 ) ) ) return ; if ( GlobalPrm_17 != NULL ) { ( void ) memcpy ( & ( rtP_xWindInNED_mps ) , GlobalPrm_17 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 18 , ( void * * ) ( & GlobalPrm_18 ) ) ) return ; if ( GlobalPrm_18 != NULL ) { ( void ) memcpy ( & ( rtP_yWindInNED_mps ) , GlobalPrm_18 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 19 , ( void * * ) ( & GlobalPrm_19 ) ) ) return ; if ( GlobalPrm_19 != NULL ) { ( void ) memcpy ( & ( rtP_zWindInNED_mps ) , GlobalPrm_19 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 20 , ( void * * ) ( & GlobalPrm_20 ) ) ) return ; if ( GlobalPrm_20 != NULL ) { ( void ) memcpy ( & ( rtP_gustEnabled ) , GlobalPrm_20 , sizeof ( boolean_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 21 , ( void * * ) ( & GlobalPrm_21 ) ) ) return ; if ( GlobalPrm_21 != NULL ) { ( void ) memcpy ( & ( rtP_turbulenceEnabled ) , GlobalPrm_21 , sizeof ( boolean_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { real_T * o_o_B_3_56 =
( real_T * ) ssGetOutputPortSignal ( S , 70 ) ; real_T * o_o_B_3_57 = ( real_T
* ) ssGetOutputPortSignal ( S , 71 ) ; real_T * o_o_o_B_3_73 = ( real_T * )
ssGetOutputPortSignal ( S , 72 ) ; real_T * localX_ = ( real_T * )
ssGetContStates ( S ) ; cjxjkcm4ra ( o_o_B_3_56 , o_o_B_3_57 , o_o_o_B_3_73 ,
localX_ ) ; } static void mdlReset ( SimStruct * S ) { real_T * localX_ = ( real_T * ) ssGetContStates ( S ) ; dapgvgjvnf ( localX_ ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { boolean_T const * i_oix1r2xyy2 = ( boolean_T * ) ssGetInputPortSignal ( S , 0 ) ; boolean_T const * i_iy0vcsbzig = ( boolean_T * ) ssGetInputPortSignal ( S , 1 ) ; boolean_T const * i_ianwr5fqin = ( boolean_T * ) ssGetInputPortSignal ( S , 2 ) ; boolean_T const * i_dk320aknro = ( boolean_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_i_domdentxv3 = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_i_brp2qkr254 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_i_pe5pkojotb = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T const * i_i_ocyemeu550 = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ; real_T const * i_i_bg0p24qife = ( real_T * ) ssGetInputPortSignal ( S , 8 ) ; real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_3_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_3_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_3_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_3_6 = ( real_T * ) ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_3_7 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; real_T * o_B_3_8 = ( real_T * ) ssGetOutputPortSignal ( S , 7 ) ; real_T * o_B_3_9 = ( real_T * ) ssGetOutputPortSignal ( S , 8 ) ; real_T * o_B_3_10 = ( real_T * ) ssGetOutputPortSignal ( S , 9 ) ; real_T * o_B_3_11 = ( real_T * ) ssGetOutputPortSignal ( S , 10 ) ; real_T * o_B_3_12 = ( real_T * ) ssGetOutputPortSignal ( S , 11 ) ; real_T * o_B_3_13 = ( real_T * ) ssGetOutputPortSignal ( S , 12 ) ; real_T * o_B_3_14 = ( real_T * ) ssGetOutputPortSignal ( S , 13 ) ; real_T * o_B_3_15 = ( real_T * ) ssGetOutputPortSignal ( S , 14 ) ; real_T * o_B_3_16 = ( real_T * ) ssGetOutputPortSignal ( S , 15 ) ; real_T * o_B_3_17 = ( real_T * ) ssGetOutputPortSignal ( S , 16 ) ; real_T * o_B_3_18 = ( real_T * ) ssGetOutputPortSignal ( S , 17 ) ; real_T * o_B_3_19 = ( real_T * ) ssGetOutputPortSignal ( S , 18 ) ; real_T * o_B_3_20 = ( real_T * ) ssGetOutputPortSignal ( S , 19 ) ; real_T * o_B_3_21 = ( real_T * ) ssGetOutputPortSignal ( S , 20 ) ; real_T * o_B_3_22 = ( real_T * ) ssGetOutputPortSignal ( S , 21 ) ; real_T * o_B_3_23 = ( real_T * ) ssGetOutputPortSignal ( S , 22 ) ; real_T * o_B_3_24 = ( real_T * ) ssGetOutputPortSignal ( S , 23 ) ; real_T * o_B_3_25 = ( real_T * ) ssGetOutputPortSignal ( S , 24 ) ; real_T * o_B_3_26 = ( real_T * ) ssGetOutputPortSignal ( S , 25 ) ; real_T * o_B_3_27 = ( real_T * ) ssGetOutputPortSignal ( S , 26 ) ; real_T * o_B_3_28 = ( real_T * ) ssGetOutputPortSignal ( S , 27 ) ; real_T * o_B_3_29 = ( real_T * ) ssGetOutputPortSignal ( S , 28 ) ; real_T * o_B_3_30 = ( real_T * ) ssGetOutputPortSignal ( S , 29 ) ; real_T * o_B_3_31 = ( real_T * ) ssGetOutputPortSignal ( S , 30 ) ; real_T * o_B_3_32 = ( real_T * ) ssGetOutputPortSignal ( S , 31 ) ; real_T * o_B_3_33 = ( real_T * ) ssGetOutputPortSignal ( S , 32 ) ; real_T * o_B_3_34 = ( real_T * ) ssGetOutputPortSignal ( S , 33 ) ; boolean_T * o_o_B_3_35 = ( boolean_T * ) ssGetOutputPortSignal ( S , 34 ) ; real_T * o_o_B_3_36 = ( real_T * ) ssGetOutputPortSignal ( S , 35 ) ; real_T * o_o_B_3_37 = ( real_T * ) ssGetOutputPortSignal ( S , 36 ) ; real_T * o_o_B_3_38 = ( real_T * ) ssGetOutputPortSignal ( S , 37 ) ; real_T * o_o_B_3_39 = ( real_T * ) ssGetOutputPortSignal ( S , 38 ) ; real_T * o_o_B_3_40 = ( real_T * ) ssGetOutputPortSignal ( S , 39 ) ; real_T * o_o_B_3_41 = ( real_T * ) ssGetOutputPortSignal ( S , 40 ) ; real_T * o_o_B_3_42 = ( real_T * ) ssGetOutputPortSignal ( S , 41 ) ; real_T * o_o_B_3_43 = ( real_T * ) ssGetOutputPortSignal ( S , 42 ) ; real_T * o_o_B_3_44 = ( real_T * ) ssGetOutputPortSignal ( S , 43 ) ; real_T * o_o_B_3_45 = ( real_T * ) ssGetOutputPortSignal ( S , 58 ) ; real_T * o_o_B_3_46 = ( real_T * ) ssGetOutputPortSignal ( S , 59 ) ; real_T * o_o_B_3_47 = ( real_T * ) ssGetOutputPortSignal ( S , 60 ) ; real_T * o_B_3_48 = ( real_T * ) ssGetOutputPortSignal ( S , 61 ) ; real_T * o_B_3_49 = ( real_T * ) ssGetOutputPortSignal ( S , 62 ) ; real_T * o_B_3_50 = ( real_T * ) ssGetOutputPortSignal ( S , 63 ) ; real_T * o_B_3_51 = ( real_T * ) ssGetOutputPortSignal ( S , 64 ) ; real_T * o_B_3_52 = ( real_T * ) ssGetOutputPortSignal ( S , 65 ) ; real_T * o_B_3_53 = ( real_T * ) ssGetOutputPortSignal ( S , 66 ) ; real_T * o_B_3_54 = ( real_T * ) ssGetOutputPortSignal ( S , 67 ) ; real_T * o_B_3_55 = ( real_T * ) ssGetOutputPortSignal ( S , 68 ) ; real_T * o_o_B_3_56 = ( real_T * ) ssGetOutputPortSignal ( S , 70 ) ; real_T * o_o_B_3_57 = ( real_T * ) ssGetOutputPortSignal ( S , 71 ) ; real_T * localX_ = ( real_T * ) ssGetContStates ( S ) ; boolean_T * localXdis_ = ( boolean_T * ) ssGetContStateDisabled ( S ) ; if ( tid == 0 ) { VehiclePlant ( i_oix1r2xyy2 , i_iy0vcsbzig , i_ianwr5fqin , i_dk320aknro , i_i_domdentxv3 , i_i_brp2qkr254 , i_i_pe5pkojotb , i_i_ocyemeu550 , i_i_bg0p24qife , o_B_3_1 , o_B_3_2 , o_B_3_3 , o_B_3_4 , o_B_3_5 , o_B_3_6 , o_B_3_7 , o_B_3_8 , o_B_3_9 , o_B_3_10 , o_B_3_11 , o_B_3_12 , o_B_3_13 , o_B_3_14 , o_B_3_15 , o_B_3_16 , o_B_3_17 , o_B_3_18 , o_B_3_19 , o_B_3_20 , o_B_3_21 , o_B_3_22 , o_B_3_23 , o_B_3_24 , o_B_3_25 , o_B_3_26 , o_B_3_27 , o_B_3_28 , o_B_3_29 , o_B_3_30 , o_B_3_31 , o_B_3_32 , o_B_3_33 , o_B_3_34 , o_o_B_3_35 , o_o_B_3_36 , o_o_B_3_37 , o_o_B_3_38 , o_o_B_3_39 , o_o_B_3_40 , o_o_B_3_41 , o_o_B_3_42 , o_o_B_3_43 , o_o_B_3_44 , o_o_B_3_45 , o_o_B_3_46 , o_o_B_3_47 , o_B_3_48 , o_B_3_49 , o_B_3_50 , o_B_3_51 , o_B_3_52 , o_B_3_53 , o_B_3_54 , o_B_3_55 , o_o_B_3_56 , o_o_B_3_57 , localX_ , localXdis_ ) ; bdatrumzy4 ( i_i_domdentxv3 , i_i_brp2qkr254 , i_i_pe5pkojotb , i_i_ocyemeu550 , i_i_bg0p24qife , o_o_B_3_35 , o_o_B_3_36 , o_o_B_3_37 , o_o_B_3_38 , o_o_B_3_39 , o_o_B_3_40 , o_o_B_3_41 , o_o_B_3_42 , o_o_B_3_43 , o_o_B_3_44 , o_o_B_3_45 , o_o_B_3_46 , o_o_B_3_47 ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 25 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetNumPeriodicContStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 9 , 80 ) ; if ( ! ssSetNumInputPorts ( S , 9 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_BOOLEAN ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
( S , 8 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 80 ) ) return ; if ( !
...
#endif
} ssSetOutputPortSampleTime ( S , 35 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 36 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 37 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 38 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 39 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 40 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 41 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 42 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 43 , 0.004 ) ; ssSetOutputPortOffsetTime ( S
...
( S , 44 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
44 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 44 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 45
...
( S , 45 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
45 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 45 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortMatrixDimensions ( S , 46
, 3 , 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 46 , FIXED_DIMS_MODE
) ; ssSetOutputPortFrameData ( S , 46 , FRAME_NO ) ; if ( ssGetSimMode ( S )
!= SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetOutputPortDataType ( S , 46 ,
SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
( S , 46 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
46 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 46 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 47
...
( S , 47 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
47 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 47 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 48
...
#endif
} ssSetOutputPortSampleTime ( S , 48 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 48 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 48 , 0 ) ; ssSetOutputPortOkToMerge
( S , 48 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
48 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 48 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 49
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 49 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 49 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 49 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 49 , 0 ) ; ssSetOutputPortOkToMerge
( S , 49 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
49 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 49 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 50
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 50 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 50 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 50 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 50 , 0 ) ; ssSetOutputPortOkToMerge
( S , 50 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
50 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 50 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 51
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 51 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 51 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 51 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 51 , 0 ) ; ssSetOutputPortOkToMerge
( S , 51 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
51 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 51 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 52
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 52 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 52 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 52 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 52 , 0 ) ; ssSetOutputPortOkToMerge
( S , 52 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
52 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 52 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 53
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 53 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 53 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 53 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 53 , 0 ) ; ssSetOutputPortOkToMerge
( S , 53 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
53 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 53 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 54
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 54 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 54 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 54 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 54 , 0 ) ; ssSetOutputPortOkToMerge
( S , 54 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
54 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 54 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 55
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 55 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 55 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 55 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 55 , 0 ) ; ssSetOutputPortOkToMerge
( S , 55 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
55 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 55 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 56
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 56 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 56 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 56 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 56 , 0 ) ; ssSetOutputPortOkToMerge
( S , 56 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
56 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 56 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 57
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 57 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 57 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 57 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 57 , 0 ) ; ssSetOutputPortOkToMerge
( S , 57 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
57 , false , false , false ) ; ssSetOutputPortOptimOpts ( S , 57 ,
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 58
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 58 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 73 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 73 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 73 , 0 ) ; ssSetOutputPortOkToMerge
( S , 73 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
73 , false , true , false ) ; ssSetOutputPortOptimOpts ( S , 73 ,
SS_NOT_REUSABLE_AND_GLOBAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 74
, 1 ) ) return ; ssSetOutputPortDimensionsMode ( S , 74 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 74 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 74 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 74 , 0 ) ; ssSetOutputPortOkToMerge
( S , 74 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
74 , false , true , false ) ; ssSetOutputPortOptimOpts ( S , 74 ,
SS_NOT_REUSABLE_AND_GLOBAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 75
, 1 ) ) return ; ssSetOutputPortDimensionsMode ( S , 75 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 75 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 75 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 75 , 0 ) ; ssSetOutputPortOkToMerge
( S , 75 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
75 , false , true , false ) ; ssSetOutputPortOptimOpts ( S , 75 ,
SS_NOT_REUSABLE_AND_GLOBAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 76
, 1 ) ) return ; ssSetOutputPortDimensionsMode ( S , 76 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 76 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 76 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 76 , 0 ) ; ssSetOutputPortOkToMerge
( S , 76 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
76 , false , true , false ) ; ssSetOutputPortOptimOpts ( S , 76 ,
SS_NOT_REUSABLE_AND_GLOBAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 77
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 77 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 77 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 77 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 77 , 0 ) ; ssSetOutputPortOkToMerge
( S , 77 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
77 , false , true , false ) ; ssSetOutputPortOptimOpts ( S , 77 ,
SS_NOT_REUSABLE_AND_GLOBAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 78
, 3 ) ) return ; ssSetOutputPortDimensionsMode ( S , 78 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 78 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 78 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 78 , 0 ) ; ssSetOutputPortOkToMerge
( S , 78 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
78 , false , true , false ) ; ssSetOutputPortOptimOpts ( S , 78 ,
SS_NOT_REUSABLE_AND_GLOBAL ) ; if ( ! ssSetOutputPortVectorDimension ( S , 79
, 1 ) ) return ; ssSetOutputPortDimensionsMode ( S , 79 , FIXED_DIMS_MODE ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 79 , mxGetInf ( ) ) ;
ssSetOutputPortOffsetTime ( S , 79 , 0 ) ;
ssSetOutputPortDiscreteValuedOutput ( S , 79 , 0 ) ; ssSetOutputPortOkToMerge
( S , 79 , SS_OK_TO_MERGE_CONDITIONAL ) ; ssSetOutputPortICAttributes ( S ,
79 , false , true , false ) ; ssSetOutputPortOptimOpts ( S , 79 ,
SS_NOT_REUSABLE_AND_GLOBAL ) ; ssSetSimStateCompliance ( S ,
USE_CUSTOM_SIM_STATE ) ; mr_VehiclePlant_RegisterSimStateChecksum ( S ) ;
ssSetNumSampleTimes ( S , 5 ) ; ssSetParameterTuningCompliance ( S , true ) ;
...
ssSetOutputPortIsNonContinuous ( S , 41 , 0 ) ;
ssSetOutputPortIsFedByBlockWithModesNoZCs ( S , 41 , 0 ) ;
ssSetOutputPortIsNonContinuous ( S , 42 , 0 ) ;
ssSetOutputPortIsFedByBlockWithModesNoZCs ( S , 42 , 0 ) ;
ssSetOutputPortIsNonContinuous ( S , 43 , 0 ) ;
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">VgBlAGgAaQBjAGwAZQBQAGwAYQBuAHQALwBlAG4AdgBpAHIAbwBuAG0AZQBuAHQAAAA=</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAA8AFGqUA=</h></hs><causes><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">ZQBuAHYAaQByAG8AbgBtAGUAbgB0AC8AZQBhAHIAdABoAAAA</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAADACfwEA=</h></hs><causes><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\" pr=\"d\"><arguments><arg type=\"encoded\">RQBhAHIAdABoAC8AVwBHAFMAOAA0ACAARwByAGEAdgBpAHQAeQAgAE0AbwBkAGUAbAAgACAAAAA=</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAADACfwEA=</h></hs></diag></causes></diag></causes></diag></diag_root>"
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { real_T * o_B_3_48 =
( real_T * ) ssGetOutputPortSignal ( S , 61 ) ; real_T * o_B_3_49 = ( real_T
* ) ssGetOutputPortSignal ( S , 62 ) ; real_T * o_B_3_50 = ( real_T * )
ssGetOutputPortSignal ( S , 63 ) ; real_T * o_B_3_72 = ( real_T * )
ssGetOutputPortSignal ( S , 69 ) ; real_T * o_o_o_B_3_73 = ( real_T * )
ssGetOutputPortSignal ( S , 72 ) ; real_T * localX_ = ( real_T * )
ssGetContStates ( S ) ; ssNonContDerivSigFeedingOutports mr_nonContOutput64 [
18 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput65 [ 18 ] ;
ssNonContDerivSigFeedingOutports mr_nonContOutput66 [ 18 ] ;
ssNonContDerivSigFeedingOutports mr_nonContOutput67 [ 18 ] ;
ssNonContDerivSigFeedingOutports mr_nonContOutput68 [ 18 ] ;
ssNonContDerivSigFeedingOutports mr_nonContOutput70 [ 18 ] ;
ssNonContDerivSigFeedingOutports mr_nonContOutput71 [ 18 ] ;
ssNonContDerivSigFeedingOutports * mr_nonContOutputArray [ 80 ] ; void *
sysRanPtr = ( NULL ) ; int_T contextTid = 0 ; ssGetContextSysRanBCPtr ( S , &
sysRanPtr ) ; ssGetContextSysTid ( S , & contextTid ) ; if ( contextTid ==
CONSTANT_TID ) { contextTid = 0 ; } mr_nonContOutputArray [ 0 ] = ( NULL ) ;
mr_nonContOutputArray [ 1 ] = ( NULL ) ; mr_nonContOutputArray [ 2 ] = ( NULL
) ; mr_nonContOutputArray [ 3 ] = ( NULL ) ; mr_nonContOutputArray [ 4 ] = ( NULL ) ; mr_nonContOutputArray [ 5 ] = ( NULL ) ; mr_nonContOutputArray [ 6 ] = ( NULL ) ; mr_nonContOutputArray [ 7 ] = ( NULL ) ; mr_nonContOutputArray [ 8 ] = ( NULL ) ; mr_nonContOutputArray [ 9 ] = ( NULL ) ; mr_nonContOutputArray [ 10 ] = ( NULL ) ; mr_nonContOutputArray [ 11 ] = ( NULL ) ; mr_nonContOutputArray [ 12 ] = ( NULL ) ; mr_nonContOutputArray [ 13 ] = ( NULL ) ; mr_nonContOutputArray [ 14 ] = ( NULL ) ; mr_nonContOutputArray [ 15 ] = ( NULL ) ; mr_nonContOutputArray [ 16 ] = ( NULL ) ; mr_nonContOutputArray [ 17 ] = ( NULL ) ; mr_nonContOutputArray [ 18 ] = ( NULL ) ; mr_nonContOutputArray [ 19 ] = ( NULL ) ; mr_nonContOutputArray [ 20 ] = ( NULL ) ; mr_nonContOutputArray [ 21 ] = ( NULL ) ; mr_nonContOutputArray [ 22 ] = ( NULL ) ; mr_nonContOutputArray [ 23 ] = ( NULL ) ; mr_nonContOutputArray [ 24 ] = ( NULL ) ; mr_nonContOutputArray [ 25 ] = ( NULL ) ; mr_nonContOutputArray [ 26 ] = ( NULL ) ; mr_nonContOutputArray [ 27 ] = ( NULL ) ; mr_nonContOutputArray [ 28 ] = ( NULL ) ; mr_nonContOutputArray [ 29 ] = ( NULL ) ; mr_nonContOutputArray [ 30 ] = ( NULL ) ; mr_nonContOutputArray [ 31 ] = ( NULL ) ; mr_nonContOutputArray [ 32 ] = ( NULL ) ; mr_nonContOutputArray [ 33 ] = ( NULL ) ; mr_nonContOutputArray [ 34 ] = ( NULL ) ; mr_nonContOutputArray [ 35 ] = ( NULL ) ; mr_nonContOutputArray [ 36 ] = ( NULL ) ; mr_nonContOutputArray [ 37 ] = ( NULL ) ; mr_nonContOutputArray [ 38 ] = ( NULL ) ; mr_nonContOutputArray [ 39 ] = ( NULL ) ; mr_nonContOutputArray [ 40 ] = ( NULL ) ; mr_nonContOutputArray [ 41 ] = ( NULL ) ; mr_nonContOutputArray [ 42 ] = ( NULL ) ; mr_nonContOutputArray [ 43 ] = ( NULL ) ; mr_nonContOutputArray [ 44 ] = ( NULL ) ; mr_nonContOutputArray [ 45 ] = ( NULL ) ; mr_nonContOutputArray [ 46 ] = ( NULL ) ; mr_nonContOutputArray [ 47 ] = ( NULL ) ; mr_nonContOutputArray [ 48 ] = ( NULL ) ; mr_nonContOutputArray [ 49 ] = ( NULL ) ; mr_nonContOutputArray [ 50 ] = ( NULL ) ; mr_nonContOutputArray [ 51 ] = ( NULL ) ; mr_nonContOutputArray [ 52 ] = ( NULL ) ; mr_nonContOutputArray [ 53 ] = ( NULL ) ; mr_nonContOutputArray [ 54 ] = ( NULL ) ; mr_nonContOutputArray [ 55 ] = ( NULL ) ; mr_nonContOutputArray [ 56 ] = ( NULL ) ; mr_nonContOutputArray [ 57 ] = ( NULL ) ; mr_nonContOutputArray [ 58 ] = ( NULL ) ; mr_nonContOutputArray [ 59 ] = ( NULL ) ; mr_nonContOutputArray [ 60 ] = ( NULL ) ; mr_nonContOutputArray [ 61 ] = ( NULL ) ; mr_nonContOutputArray [ 62 ] = ( NULL ) ; mr_nonContOutputArray [ 63 ] = ( NULL ) ; mr_nonContOutputArray [ 64 ] = mr_nonContOutput64 ; mr_nonContOutputArray [ 65 ] = mr_nonContOutput65 ; mr_nonContOutputArray [ 66 ] = mr_nonContOutput66 ; mr_nonContOutputArray [ 67 ] = mr_nonContOutput67 ; mr_nonContOutputArray [ 68 ] = mr_nonContOutput68 ; mr_nonContOutputArray [ 69 ] = ( NULL ) ; mr_nonContOutputArray [ 70 ] = mr_nonContOutput70 ; mr_nonContOutputArray [ 71 ] = mr_nonContOutput71 ; mr_nonContOutputArray [ 72 ] = ( NULL ) ; mr_nonContOutputArray [ 73 ] = ( NULL ) ; mr_nonContOutputArray [ 74 ] = ( NULL ) ; mr_nonContOutputArray [ 75 ] = ( NULL ) ; mr_nonContOutputArray [ 76 ] = ( NULL ) ; mr_nonContOutputArray [ 77 ] = ( NULL ) ; mr_nonContOutputArray [ 78 ] = ( NULL ) ; mr_nonContOutputArray [ 79 ] = ( NULL ) ; simTgtAllocOPModelData ( S ) ; dwjsblzuar ( o_B_3_48 , o_B_3_49 , o_B_3_50 , o_B_3_72 , o_o_o_B_3_73 , S , mr_nonContOutputArray , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 2 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 3 , true ) , localX_ , sysRanPtr , contextTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( owiw5mmjy2 . rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 64 , mr_nonContOutput64 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 65 , mr_nonContOutput65 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 66 , mr_nonContOutput66 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 67 , mr_nonContOutput67 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 68 , mr_nonContOutput68 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 70 , mr_nonContOutput70 ) ) return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 71 , mr_nonContOutput71 ) ) return ; } gyzb3lqody ( ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { real_T * o_o_o_B_3_73 = ( real_T * )
ssGetOutputPortSignal ( S , 72 ) ; mdlProcessParameters ( S ) ; hqrg4vgws5 ( o_o_o_B_3_73 ) ; }
#define RTW_GENERATED_DISABLE
static void mdlDisable ( SimStruct * S ) { iv0fdu4uqg ( ) ; return ; } static
void mdlOutputs ( SimStruct * S , int_T tid ) { boolean_T const *
i_oix1r2xyy2 = ( boolean_T * ) ssGetInputPortSignal ( S , 0 ) ; boolean_T
const * i_iy0vcsbzig = ( boolean_T * ) ssGetInputPortSignal ( S , 1 ) ;
boolean_T const * i_ianwr5fqin = ( boolean_T * ) ssGetInputPortSignal ( S , 2
) ; boolean_T const * i_dk320aknro = ( boolean_T * ) ssGetInputPortSignal ( S
, 3 ) ; real_T const * i_i_domdentxv3 = ( real_T * ) ssGetInputPortSignal ( S
, 4 ) ; real_T const * i_i_brp2qkr254 = ( real_T * ) ssGetInputPortSignal ( S
, 5 ) ; real_T const * i_i_pe5pkojotb = ( real_T * ) ssGetInputPortSignal ( S
, 6 ) ; real_T const * i_i_ocyemeu550 = ( real_T * ) ssGetInputPortSignal ( S
, 7 ) ; real_T const * i_i_bg0p24qife = ( real_T * ) ssGetInputPortSignal ( S
, 8 ) ; real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T *
o_B_3_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_3_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_3_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_3_6 = ( real_T * ) ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_3_7 = ( real_T * ) ssGetOutputPortSignal ( S , 6 ) ; real_T * o_B_3_8 = ( real_T * ) ssGetOutputPortSignal ( S , 7 ) ; real_T * o_B_3_9 = ( real_T * ) ssGetOutputPortSignal ( S , 8 ) ; real_T * o_B_3_10 = ( real_T * ) ssGetOutputPortSignal ( S , 9 ) ; real_T * o_B_3_11 = ( real_T * ) ssGetOutputPortSignal ( S , 10 ) ; real_T * o_B_3_12 = ( real_T * ) ssGetOutputPortSignal ( S , 11 ) ; real_T * o_B_3_13 = ( real_T * ) ssGetOutputPortSignal ( S , 12 ) ; real_T * o_B_3_14 = ( real_T * ) ssGetOutputPortSignal ( S , 13 ) ; real_T * o_B_3_15 = ( real_T * ) ssGetOutputPortSignal ( S , 14 ) ; real_T * o_B_3_16 = ( real_T * ) ssGetOutputPortSignal ( S , 15 ) ; real_T * o_B_3_17 = ( real_T * ) ssGetOutputPortSignal ( S , 16 ) ; real_T * o_B_3_18 = ( real_T * ) ssGetOutputPortSignal ( S , 17 ) ; real_T * o_B_3_19 = ( real_T * ) ssGetOutputPortSignal ( S , 18 ) ; real_T * o_B_3_20 = ( real_T * ) ssGetOutputPortSignal ( S , 19 ) ; real_T * o_B_3_21 = ( real_T * ) ssGetOutputPortSignal ( S , 20 ) ; real_T * o_B_3_22 = ( real_T * ) ssGetOutputPortSignal ( S , 21 ) ; real_T * o_B_3_23 = ( real_T * ) ssGetOutputPortSignal ( S , 22 ) ; real_T * o_B_3_24 = ( real_T * ) ssGetOutputPortSignal ( S , 23 ) ; real_T * o_B_3_25 = ( real_T * ) ssGetOutputPortSignal ( S , 24 ) ; real_T * o_B_3_26 = ( real_T * ) ssGetOutputPortSignal ( S , 25 ) ; real_T * o_B_3_27 = ( real_T * ) ssGetOutputPortSignal ( S , 26 ) ; real_T * o_B_3_28 = ( real_T * ) ssGetOutputPortSignal ( S , 27 ) ; real_T * o_B_3_29 = ( real_T * ) ssGetOutputPortSignal ( S , 28 ) ; real_T * o_B_3_30 = ( real_T * ) ssGetOutputPortSignal ( S , 29 ) ; real_T * o_B_3_31 = ( real_T * ) ssGetOutputPortSignal ( S , 30 ) ; real_T * o_B_3_32 = ( real_T * ) ssGetOutputPortSignal ( S , 31 ) ; real_T * o_B_3_33 = ( real_T * ) ssGetOutputPortSignal ( S , 32 ) ; real_T * o_B_3_34 = ( real_T * ) ssGetOutputPortSignal ( S , 33 ) ; boolean_T * o_o_B_3_35 = ( boolean_T * ) ssGetOutputPortSignal ( S , 34 ) ; real_T * o_o_B_3_36 = ( real_T * ) ssGetOutputPortSignal ( S , 35 ) ; real_T * o_o_B_3_37 = ( real_T * ) ssGetOutputPortSignal ( S , 36 ) ; real_T * o_o_B_3_38 = ( real_T * ) ssGetOutputPortSignal ( S , 37 ) ; real_T * o_o_B_3_39 = ( real_T * ) ssGetOutputPortSignal ( S , 38 ) ; real_T * o_o_B_3_40 = ( real_T * ) ssGetOutputPortSignal ( S , 39 ) ; real_T * o_o_B_3_41 = ( real_T * ) ssGetOutputPortSignal ( S , 40 ) ; real_T * o_o_B_3_42 = ( real_T * ) ssGetOutputPortSignal ( S , 41 ) ; real_T * o_o_B_3_43 = ( real_T * ) ssGetOutputPortSignal ( S , 42 ) ; real_T * o_o_B_3_44 = ( real_T * ) ssGetOutputPortSignal ( S , 43 ) ; real_T * o_o_B_3_45 = ( real_T * ) ssGetOutputPortSignal ( S , 58 ) ; real_T * o_o_B_3_46 = ( real_T * ) ssGetOutputPortSignal ( S , 59 ) ; real_T * o_o_B_3_47 = ( real_T * ) ssGetOutputPortSignal ( S , 60 ) ; real_T * o_B_3_48 = ( real_T * ) ssGetOutputPortSignal ( S , 61 ) ; real_T * o_B_3_49 = ( real_T * ) ssGetOutputPortSignal ( S , 62 ) ; real_T * o_B_3_50 = ( real_T * ) ssGetOutputPortSignal ( S , 63 ) ; real_T * o_B_3_51 = ( real_T * ) ssGetOutputPortSignal ( S , 64 ) ; real_T * o_B_3_52 = ( real_T * ) ssGetOutputPortSignal ( S , 65 ) ; real_T * o_B_3_53 = ( real_T * ) ssGetOutputPortSignal ( S , 66 ) ; real_T * o_B_3_54 = ( real_T * ) ssGetOutputPortSignal ( S , 67 ) ; real_T * o_B_3_55 = ( real_T * ) ssGetOutputPortSignal ( S , 68 ) ; real_T * o_o_B_3_56 = ( real_T * ) ssGetOutputPortSignal ( S , 70 ) ; real_T * o_o_B_3_57 = ( real_T * ) ssGetOutputPortSignal ( S , 71 ) ; real_T * localX_ = ( real_T * ) ssGetContStates ( S ) ; boolean_T * localXdis_ = ( boolean_T * ) ssGetContStateDisabled ( S ) ; real_T * o_B_3_58 = ( real_T * ) ssGetOutputPortSignal ( S , 44 ) ; real_T * o_B_3_59 = ( real_T * ) ssGetOutputPortSignal ( S , 45 ) ; real_T * o_B_3_60 = ( real_T * ) ssGetOutputPortSignal ( S , 46 ) ; real_T * o_B_3_61 = ( real_T * ) ssGetOutputPortSignal ( S , 47 ) ; real_T * o_B_3_62 = ( real_T * ) ssGetOutputPortSignal ( S , 48 ) ; real_T * o_B_3_63 = ( real_T * ) ssGetOutputPortSignal ( S , 49 ) ; real_T * o_B_3_64 = ( real_T * ) ssGetOutputPortSignal ( S , 50 ) ; real_T * o_B_3_65 = ( real_T * ) ssGetOutputPortSignal ( S , 51 ) ; real_T * o_B_3_66 = ( real_T * ) ssGetOutputPortSignal ( S , 52 ) ; real_T * o_B_3_67 = ( real_T * ) ssGetOutputPortSignal ( S , 53 ) ; real_T * o_B_3_68 = ( real_T * ) ssGetOutputPortSignal ( S , 54 ) ; real_T * o_B_3_69 = ( real_T * ) ssGetOutputPortSignal ( S , 55 ) ; real_T * o_B_3_70 = ( real_T * ) ssGetOutputPortSignal ( S , 56 ) ; real_T * o_B_3_71 = ( real_T * ) ssGetOutputPortSignal ( S , 57 ) ; real_T * o_B_3_72 = ( real_T * ) ssGetOutputPortSignal ( S , 69 ) ; real_T * o_o_o_B_3_73 = ( real_T * ) ssGetOutputPortSignal ( S , 72 ) ; if ( tid == PARAMETER_TUNING_TID ) { VehiclePlantTID3 ( o_B_3_58 , o_B_3_59 , o_B_3_60 , o_B_3_61 , o_B_3_62 , o_B_3_63 , o_B_3_64 , o_B_3_65 , o_B_3_66 , o_B_3_67 , o_B_3_68 , o_B_3_69 , o_B_3_70 , o_B_3_71 , o_B_3_72 , o_o_o_B_3_73 ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) { VehiclePlant ( i_oix1r2xyy2 , i_iy0vcsbzig , i_ianwr5fqin , i_dk320aknro , i_i_domdentxv3 , i_i_brp2qkr254 , i_i_pe5pkojotb , i_i_ocyemeu550 , i_i_bg0p24qife , o_B_3_1 , o_B_3_2 , o_B_3_3 , o_B_3_4 , o_B_3_5 , o_B_3_6 , o_B_3_7 , o_B_3_8 , o_B_3_9 , o_B_3_10 , o_B_3_11 , o_B_3_12 , o_B_3_13 , o_B_3_14 , o_B_3_15 , o_B_3_16 , o_B_3_17 , o_B_3_18 , o_B_3_19 , o_B_3_20 , o_B_3_21 , o_B_3_22 , o_B_3_23 , o_B_3_24 , o_B_3_25 , o_B_3_26 , o_B_3_27 , o_B_3_28 , o_B_3_29 , o_B_3_30 , o_B_3_31 , o_B_3_32 , o_B_3_33 , o_B_3_34 , o_o_B_3_35 , o_o_B_3_36 , o_o_B_3_37 , o_o_B_3_38 , o_o_B_3_39 , o_o_B_3_40 , o_o_B_3_41 , o_o_B_3_42 , o_o_B_3_43 , o_o_B_3_44 , o_o_B_3_45 , o_o_B_3_46 , o_o_B_3_47 , o_B_3_48 , o_B_3_49 , o_B_3_50 , o_B_3_51 , o_B_3_52 , o_B_3_53 , o_B_3_54 , o_B_3_55 , o_o_B_3_56 , o_o_B_3_57 , localX_ , localXdis_ ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { real_T const *
i_i_domdentxv3 = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const *
i_i_brp2qkr254 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const *
i_i_pe5pkojotb = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T const *
i_i_ocyemeu550 = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ; real_T const *
i_i_bg0p24qife = ( real_T * ) ssGetInputPortSignal ( S , 8 ) ; boolean_T *
o_o_B_3_35 = ( boolean_T * ) ssGetOutputPortSignal ( S , 34 ) ; real_T *
o_o_B_3_36 = ( real_T * ) ssGetOutputPortSignal ( S , 35 ) ; real_T *
o_o_B_3_37 = ( real_T * ) ssGetOutputPortSignal ( S , 36 ) ; real_T *
o_o_B_3_38 = ( real_T * ) ssGetOutputPortSignal ( S , 37 ) ; real_T *
o_o_B_3_39 = ( real_T * ) ssGetOutputPortSignal ( S , 38 ) ; real_T *
o_o_B_3_40 = ( real_T * ) ssGetOutputPortSignal ( S , 39 ) ; real_T *
o_o_B_3_41 = ( real_T * ) ssGetOutputPortSignal ( S , 40 ) ; real_T *
o_o_B_3_42 = ( real_T * ) ssGetOutputPortSignal ( S , 41 ) ; real_T *
o_o_B_3_43 = ( real_T * ) ssGetOutputPortSignal ( S , 42 ) ; real_T *
o_o_B_3_44 = ( real_T * ) ssGetOutputPortSignal ( S , 43 ) ; real_T *
o_o_B_3_45 = ( real_T * ) ssGetOutputPortSignal ( S , 58 ) ; real_T *
o_o_B_3_46 = ( real_T * ) ssGetOutputPortSignal ( S , 59 ) ; real_T *
o_o_B_3_47 = ( real_T * ) ssGetOutputPortSignal ( S , 60 ) ; bdatrumzy4 ( i_i_domdentxv3 , i_i_brp2qkr254 , i_i_pe5pkojotb , i_i_ocyemeu550 , i_i_bg0p24qife , o_o_B_3_35 , o_o_B_3_36 , o_o_B_3_37 , o_o_B_3_38 , o_o_B_3_39 , o_o_B_3_40 , o_o_B_3_41 , o_o_B_3_42 , o_o_B_3_43 , o_o_B_3_44 , o_o_B_3_45 , o_o_B_3_46 , o_o_B_3_47 ) ; return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { real_T * localX_ = ( real_T *
) ssGetContStates ( S ) ; real_T * localXdot_ = ( real_T * ) ssGetdX ( S ) ;
m5u2c0ldal ( localX_ , localXdot_ ) ; } static void mdlTerminate ( SimStruct
* S ) { omtgknbblj ( ) ; simTgtFreeOPModelData ( S ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { dgmiwxg00f ( ) ; }
...
const real_T * localX = ( const real_T * ) ssGetContStates ( S ) ; const
int_T numStates = ssGetNumContStates ( S ) ; const size_t numBytes =
numStates * sizeof ( real_T ) ; mxArray * storedX = mxCreateNumericMatrix ( 1
, numBytes , mxUINT8_CLASS , mxREAL ) ; UINT8_T * rawData = ( UINT8_T * )
mxGetData ( storedX ) ; memcpy ( & rawData [ 0 ] , localX , numBytes ) ;
mxSetFieldByNumber ( ss , 0 , 0 , storedX ) ; } { mxArray * mdlrefDW =
mr_VehiclePlant_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ;
} { mxArray * data = mr_VehiclePlant_GetSimStateDisallowedBlocks ( ) ;
...
simTgtDeserializeVoidMemoryOP ( S , voidMemData ) ; } { real_T * localX = ( real_T * ) ssGetContStates ( S ) ; const int_T numStates = ssGetNumContStates ( S ) ; const size_t numBytes = numStates * sizeof ( real_T ) ; const mxArray * storedX = mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T * ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ; } mr_VehiclePlant_SetDWork ( mxGetFieldByNumber ( ss , 0 , 1 ) ) ; ssSetTNext ( S , ( time_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 3 ) ) ) ; ssSetTNextTid ( S , ( int_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 4 ) ) ) ; }
