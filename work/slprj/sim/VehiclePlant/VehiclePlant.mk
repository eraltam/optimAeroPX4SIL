...
## Generated on : Mon Jul 20 17:07:17 2026
...
SRCS = $(START_DIR)/slprj/sim/VehiclePlant/VehiclePlant.c $(START_DIR)/slprj/sim/VehiclePlant/VehiclePlant_capi.c
...
OBJS = VehiclePlant.obj VehiclePlant_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/VehiclePlant/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/VehiclePlant/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/VehiclePlant/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/VehiclePlant/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/VehiclePlant/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
