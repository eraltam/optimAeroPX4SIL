...
## Generated on : Thu Jul 23 13:43:19 2026
## Final product: .\VehiclePlantlib.lib
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_matrx.c $(MATLAB_ROOT)\rtw\c\src\rt_printf.c $(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant.c $(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_capi.c $(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_data.c
...
OBJS = rt_matrx.obj rt_printf.obj VehiclePlant.obj VehiclePlant_capi.obj VehiclePlant_data.obj
...
{$(START_DIR)\slprj\sim\VehiclePlant}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\VehiclePlant}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\VehiclePlant}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\VehiclePlant}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
VehiclePlant.obj : "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant.c"


VehiclePlant_capi.obj : "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_capi.c"


VehiclePlant_data.obj : "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\VehiclePlant\VehiclePlant_data.c"
