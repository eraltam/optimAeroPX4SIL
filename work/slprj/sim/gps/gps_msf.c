...
mdlrefDW = mr_gps_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss
...
mr_gps_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1 ) )
