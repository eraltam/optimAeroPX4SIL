...
## Generated on : Thu Jul 23 13:05:44 2026
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = hexAeroCoefficientsModellib.lib
...
PRODUCT = .\hexAeroCoefficientsModellib.lib
...
SRCS = $(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel.c $(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel_capi.c
...
OBJS = hexAeroCoefficientsModel.obj hexAeroCoefficientsModel_capi.obj
...
{$(START_DIR)\slprj\sim\hexAeroCoefficientsModel}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAeroCoefficientsModel}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAeroCoefficientsModel}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\hexAeroCoefficientsModel}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
hexAeroCoefficientsModel.obj : "$(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel.c"


hexAeroCoefficientsModel_capi.obj : "$(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel_capi.c"
