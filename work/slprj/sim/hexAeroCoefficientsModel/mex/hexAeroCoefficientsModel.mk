...
## Generated on : Mon Jul 13 14:40:58 2026
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -L"C:/Program Files/MATLAB/R2026a/extern/lib/win64/mingw64" -llibmwipp -llibfixedpoint -llibmwmathutil -llibmwsl_AsyncioQueue -lsf_runtime -llibmwslexec_simlog -llibmwcoder_ToAsyncQueueTgtAppSvc -llibmwsl_simtarget_instrumentation -llibmwsl_simtarget_core -llibmwstringutil -llibemlrt -llibmx -llibmex
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS)
	...
	$(LD) $(SHAREDLIB_LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) -Wl,--start-group @$(MODELREF_LINK_RSPFILE) $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS) -Wl,--end-group
