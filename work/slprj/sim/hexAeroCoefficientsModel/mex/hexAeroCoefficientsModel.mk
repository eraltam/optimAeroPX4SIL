...
## Generated on : Thu Jul 23 13:05:45 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\hexAeroCoefficientsModel_msf.mexw64
...
PRODUCT_NAME              = hexAeroCoefficientsModel
MAKEFILE                  = hexAeroCoefficientsModel.mk
...
MODELREF_LINK_RSPFILE     = hexAeroCoefficientsModel_ref.rsp
COMPILER_COMMAND_FILE     = hexAeroCoefficientsModel_comp.rsp
CMD_FILE                  = hexAeroCoefficientsModel.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\hexAeroCoefficientsModel_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=hexAeroCoefficientsModel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = hexAeroCoefficientsModel_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModellib.lib
...
LDFLAGS_ = /IMPLIB:hexAeroCoefficientsModel_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:hexAeroCoefficientsModel_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:hexAeroCoefficientsModel_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:hexAeroCoefficientsModel_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
hexAeroCoefficientsModel_msf.obj : "$(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\hexAeroCoefficientsModel\hexAeroCoefficientsModel_msf.c"
