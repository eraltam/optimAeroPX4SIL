...
## Generated on : Thu Jul 23 13:04:10 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\cgMassInertia_msf.mexw64
...
MODELREF_LINK_RSPFILE     = cgMassInertia_ref.rsp
COMPILER_COMMAND_FILE     = cgMassInertia_comp.rsp
CMD_FILE                  = cgMassInertia.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\cgMassInertia_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=cgMassInertia -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = cgMassInertia_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\cgMassInertia\cgMassInertialib.lib
...
LDFLAGS_ = /IMPLIB:cgMassInertia_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:cgMassInertia_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:cgMassInertia_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:cgMassInertia_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
cgMassInertia_msf.obj : "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_msf.c"
