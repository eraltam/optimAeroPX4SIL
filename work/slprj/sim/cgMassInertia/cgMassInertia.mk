...
## Generated on : Thu Jul 23 13:04:08 2026
...
SRCS = $(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia.c $(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_capi.c $(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_data.c
...
OBJS = cgMassInertia.obj cgMassInertia_capi.obj cgMassInertia_data.obj
...
{$(START_DIR)\slprj\sim\cgMassInertia}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\cgMassInertia}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\cgMassInertia}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\cgMassInertia}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
cgMassInertia.obj : "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia.c"


cgMassInertia_capi.obj : "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_capi.c"


cgMassInertia_data.obj : "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\cgMassInertia\cgMassInertia_data.c"
