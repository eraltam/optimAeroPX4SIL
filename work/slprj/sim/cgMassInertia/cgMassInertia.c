...
* ) "cgMassInertia" } } ; cci5zeak1tu cci5zeak1t = { 7.441 , { 0.0 , 0.0 ,
0.0 } , { 0.45405089150399996 , 0.0 , 0.0 , 0.0 , 0.45405089150399996 , 0.0 ,
0.0 , 0.0 , 0.871268833008 } } ; void hldptrix4x ( real_T * kve0m1jdyq ,
real_T mytftut522 [ 3 ] , real_T ndlmpi30oe [ 9 ] ) { * kve0m1jdyq =
cci5zeak1t . P_0 ; mytftut522 [ 0 ] = cci5zeak1t . P_1 [ 0 ] ; mytftut522 [ 1
] = cci5zeak1t . P_1 [ 1 ] ; mytftut522 [ 2 ] = cci5zeak1t . P_1 [ 2 ] ;
memcpy ( & ndlmpi30oe [ 0 ] , & cci5zeak1t . P_2 [ 0 ] , 9U * sizeof ( real_T
) ) ; } void jjipi5h0uc ( real_T * kve0m1jdyq , real_T mytftut522 [ 3 ] ,
real_T ndlmpi30oe [ 9 ] ) { * kve0m1jdyq = cci5zeak1t . P_0 ; mytftut522 [ 0
] = cci5zeak1t . P_1 [ 0 ] ; mytftut522 [ 1 ] = cci5zeak1t . P_1 [ 1 ] ;
mytftut522 [ 2 ] = cci5zeak1t . P_1 [ 2 ] ; memcpy ( & ndlmpi30oe [ 0 ] , &
cci5zeak1t . P_2 [ 0 ] , 9U * sizeof ( real_T ) ) ; } void cgMassInertiaTID1
( real_T * kve0m1jdyq , real_T mytftut522 [ 3 ] , real_T ndlmpi30oe [ 9 ] ) {
