...
## Generated on : Thu Jul 23 11:19:10 2026
...
MODELREF_LINK_RSPFILE     = ins_anello_ref.rsp
COMPILER_COMMAND_FILE     = ins_anello_comp.rsp
CMD_FILE                  = ins_anello.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ins_anello_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=ins_anello -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\sim\ins_anello\ins_anello_msf.c $(MATLAB_ROOT)\extern\version\c_mexapi_version.c
...
OBJS = ins_anello_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:\SITL\AnelloSummer\optimAeroPX4SIL\work\slprj\sim\ins_anello\ins_anellolib.lib
...
LDFLAGS_ = /IMPLIB:ins_anello_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SHAREDLIB_LDFLAGS_ = /IMPLIB:ins_anello_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_LDFLAGS_ = /IMPLIB:ins_anello_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
CPP_SHAREDLIB_LDFLAGS_ = /IMPLIB:ins_anello_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
ins_anello_msf.obj : "$(START_DIR)\slprj\sim\ins_anello\ins_anello_msf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\ins_anello\ins_anello_msf.c"
