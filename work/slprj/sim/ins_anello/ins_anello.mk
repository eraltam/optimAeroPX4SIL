...
## Generated on : Thu Jul 23 11:19:08 2026
...
SRCS = $(START_DIR)\slprj\sim\ins_anello\ins_anello.c $(START_DIR)\slprj\sim\ins_anello\ins_anello_capi.c
...
OBJS = ins_anello.obj ins_anello_capi.obj
...
{$(START_DIR)\slprj\sim\ins_anello}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\ins_anello}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\ins_anello}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\sim\ins_anello}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ins_anello.obj : "$(START_DIR)\slprj\sim\ins_anello\ins_anello.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\ins_anello\ins_anello.c"


ins_anello_capi.obj : "$(START_DIR)\slprj\sim\ins_anello\ins_anello_capi.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\sim\ins_anello\ins_anello_capi.c"
