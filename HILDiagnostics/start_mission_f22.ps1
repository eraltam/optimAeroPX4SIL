...
# PX4 instance 0, TCP 4560, and the MAVLink ports are shared by every vehicle.
# Refuse to replace a live mission instead of treating its PX4 process as stale.
