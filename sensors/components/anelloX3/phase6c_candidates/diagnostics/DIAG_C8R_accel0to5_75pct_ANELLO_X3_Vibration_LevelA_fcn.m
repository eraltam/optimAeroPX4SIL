function [accel_vib_mps2, gyro_vib_radps] = DIAG_C8R_accel0to5_75pct_ANELLO_X3_Vibration_LevelA_fcn(rotorAngVel_radps, enableVibration, seed_u32)
% DIAGNOSTIC ONLY -- not a candidate, never wired into any .slx, never flown. Identical to C8R
% except G_accel(1) (0-5Hz gain) scaled to 75% of its full value (2.2177146100), per the
...
G_accel = [2.2177146100 * 75/100, 0.5014011500, 1.1786216400, 0.7244736800];
